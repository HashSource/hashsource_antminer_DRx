...
void set_BM1722_asic_register(undefined1 param_1,undefined1 param_2,undefined1 param_3,char param_4,undefined4 param_5)
...

{
  ...
  for (local_10 = 0; uVar1 = __udivsi3(0x100,gChain_Asic_Interval), local_10 < uVar1; local_10 = local_10 + 1) {
...

{
        ...
        if (param_1 == *(byte *)(reg_value_buf + *(int *)(reg_value_buf + 4) * 10 + 0x19)) {
          ...
          if (uVar1 == *(byte *)(reg_value_buf + *(int *)(reg_value_buf + 4) * 10 + 0x18)) {
            ...
            local_1c = (uint)*(byte *)(reg_value_buf + *(int *)(reg_value_buf + 4) * 10 + 0x13) |
                       (uint)*(byte *)(reg_value_buf + *(int *)(reg_value_buf + 4) * 10 + 0x10) << 0x18 |
                       (uint)*(byte *)(reg_value_buf + *(int *)(reg_value_buf + 4) * 10 + 0x11) << 0x10 |
          ...
          *(int *)(reg_value_buf + 8) = *(int *)(reg_value_buf + 8) + -1;
          ...
          printf("%s: the return data is from chain%d, but it should be from chain%d\n","check_BM1722_asic_reg",
                 (uint)*(byte *)(reg_value_buf + *(int *)(reg_value_buf + 4) * 10 + 0x19),(uint)param_1);
          pthread_mutex_unlock((pthread_mutex_t *)reg_mutex);
        }
      }
    }
  ...
  if (param_3 == '\0') {
    ...
    printf("%s: chain J%d has %d ASIC\n","check_BM1722_asic_reg",param_1 + 1,(uint)(byte)cgpu[param_1 + 0x1004b8]);
  }
  clear_register_value_buf();
  return local_1c;
}
...

{
  ...
  *(undefined1 *)((int)&start_receive + (uint)gChain) = 1;
  ...
  check_BM1722_asic_reg(gChain,0,0,1);
  printf("\n--- check chain: J%d has asicNum = %d\n",(uint)gChain,(uint)(byte)cgpu[gChain + 0x1004b8]);
  if ((uint)(byte)cgpu[gChain + 0x1004b8] == Conf._108_4_) {
    chain_reset(gChain);
    uart_flush(gChain);
    ...
    if ((uint)(byte)cgpu[gChain + 0x1004b8] == Conf._108_4_) {
      ...
      *(undefined1 *)((int)&gStartTest + (uint)gChain) = 1;
      ...
      write_lcd_no_memset(1,local_2c,0x10);
      write_lcd_no_memset(2,"      ASIC      ",0x10);
      printf("\n\n---%s: Only have %d ASIC\n","singleBoardTest_BBD12601",(uint)(byte)cgpu[gChain + 0x1004b8]);
      sleep(Conf._264_4_);
      enable_PIC16F1704_dc_dc(gChain,0,0);
    }
  }
...
void set_BM1725_asic_register(undefined1 param_1,undefined1 param_2,undefined1 param_3,char param_4,undefined4 param_5)
...

{
  ...
  local_c = 0;
  local_18 = 0.0;
  printf("\n%s: freq = %f\n","set_BM1725_freq",SUB84((double)param_1,0),(int)((ulonglong)(double)param_1 >> 0x20));
  local_c = get_pllparam_divider(param_1,&local_10,&local_11,&local_18);
  local_10 = local_10 | 0xc0000000;
  local_11 = local_11 - 1;
  printf("\n%s: pll_param = %08x, divider = %02x, pll_freq = %f\n","set_BM1725_freq",local_10,(uint)local_11,
         (double)local_18);
...

{
  ...
  if (param_3 == '\0') {
    ...
    printf("%s: chain J%d has %d ASIC\n","check_BM1725_asic_reg",param_1 + 1,(uint)(byte)cgpu[param_1 + 0x1004b8]);
  }
  clear_register_value_buf();
  return local_2c;
}
  ...
  *(undefined1 *)((int)&start_receive + (uint)gChain) = 1;
  ...
  if ((uint)(byte)cgpu[gChain + 0x1004b8] == Conf._108_4_) {
    ...
    if ((uint)(byte)cgpu[gChain + 0x1004b8] == Conf._108_4_) {
      ...
      local_18 = single_board_get_result(gChain);
      if ((local_18 == 7) &&
         (g_test_epprom = save_voltage_info_to_eeprom(Conf._68_4_,Conf._156_4_), g_test_epprom != '\x01')) {
      ...
      write_lcd_no_memset(1,local_2c,0x10);
      write_lcd_no_memset(2,"      ASIC      ",0x10);
      printf("\n\n---%s: Only have %d ASIC\n","singleBoardTest_BBD25601",(uint)(byte)cgpu[gChain + 0x1004b8]);
      sleep(Conf._264_4_);
      enable_PIC16F1704_dc_dc(gChain,0,0);
      power_off();
    }
    ...
    while( true ) {
      do {
        ...
        if (pcVar1 == (char *)0x0) {
          ...
          else if ((gHashBoard_BBD12601 != '\0') || (pcVar1 = (char *)(uint)gHashBoard_BBD25601, pcVar1 != (char *)0x0))
          {
            if (*(int *)(local_14 + 0x74) == 0x6ba) {
              strcpy(cgpu + 0x80020,BM1722_WorkDataPathPrefix);
              strcpy(cgpu + 0x80060,DCR_WorkDataFilePrefix);
                                          ...
                                          if (local_c == (char *)0x0) {
                                            ...
                                            if (local_c == (char *)0x0) {
                                              ...
                                              if (local_c == (char *)0x0) {
                                                ...
                                                if (local_c == (char *)0x0) {
                                                  ...
                                                  if (local_c == (char *)0x0) {
                                                    ...
                                                    if (local_c == (char *)0x0) {
                                                      ...
                                                      if (local_c == (char *)0x0) {
                                                        local_c = strstr(&local_41c,"remote_local_gap=");
                                                        if (local_c == (char *)0x0) {
                                                          local_c = strstr(&local_41c,"TempSensor1=");
                                                          if (local_c == (char *)0x0) {
                                                            local_c = strstr(&local_41c,"TempSensor2=");
                                                            if (local_c == (char *)0x0) {
                                                              local_c = strstr(&local_41c,"TempSensor3=");
                                                              if (local_c == (char *)0x0) {
                                                                local_c = strstr(&local_41c,"StartSensor=");
                                                                if (local_c == (char *)0x0) {
                                                            ...
                                                            if (local_c == (char *)0x0) {
                                                              local_c = strstr(&local_41c,"Most_lost_nonce_total=");
                                                              if (local_c == (char *)0x0) {
                                                                local_c = strstr(&local_41c,"Most_HW_Num=");
                                                                if (local_c == (char *)0x0) {
                                                                  local_c = strstr(&local_41c,"close_power_delay=");
                                                                  if (local_c != (char *)0x0) {
                                                                  ...
                                                                  local_c = local_c + 0xc;
                                                                  __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xf8)
                                                                  ;
                                                                }
                                                              }
                                                              else {
                                                                local_c = local_c + 0x16;
                                                                __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xf4);
                                                              }
                                                            }
                                                            else {
                                                              local_c = local_c + 0x15;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xf0);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0x11;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xec);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0x11;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xe8);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0xb;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xdc);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0xe;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xd8);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 10;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xd6);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0x12;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xe4);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0x1a;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xe0);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0xb;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xd5);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 10;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xd4);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0xc;
                                                              __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xd3);
                                                            }
                                                            }
                                                            else {
                                                              local_c = local_c + 0xc;
                                                              __isoc99_sscanf(local_c,&DAT_00028bb8,local_14 + 0xd2);
                                                              if (local_14[0xd2] != '\0') {
                                                              ...
                                                              local_c = local_c + 0xc;
                                                              __isoc99_sscanf(local_c,&DAT_00028bb8,local_14 + 0xd1);
                                                              if (local_14[0xd1] != '\0') {
                                                                gSensor_number = gSensor_number + 1;
                                                              }
                                                            }
                                                            ...
                                                            local_c = local_c + 0xc;
                                                            __isoc99_sscanf(local_c,&DAT_00028bb8,local_14 + 0xd0);
                                                            if (local_14[0xd0] != '\0') {
                                                              gSensor_number = gSensor_number + 1;
                                                            }
                                                          }
                                                          ...
                                                          local_c = local_c + 0x11;
                                                          __isoc99_sscanf(local_c,&DAT_00028bb8,local_14 + 0x100);
                                                        }
                                                      }
                                                      else {
                                                        local_c = local_c + 0xd;
                                                        __isoc99_sscanf(local_c,&DAT_00028bb8,local_14 + 0xfc);
                                                      }
                                                    }
                                                    else {
                                                      local_c = local_c + 10;
                                                      __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xcc);
                                                    }
                                                  }
                                                  else {
                                                    local_c = local_c + 0xc;
                                                    __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xc4);
                                                  }
                                                }
                                                else {
                                                  local_c = local_c + 9;
                                                  __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xc0);
                                                ...
                                                local_c = local_c + 9;
                                                __isoc99_sscanf(local_c,&DAT_00028ab0,local_14 + 0xbc);
    ...
    if ((((*local_14 == 'B') && (local_14[1] == 'B')) && (local_14[2] == 'D')) &&
      ...
      printf("\n---%s: gHashBoard_BBD12601\n\n","read_config");
            ...
            (((((local_14[1] == 'B' && (local_14[2] == 'D')) && (local_14[3] == '2')) &&
              ((local_14[4] == '5' && (local_14[5] == '6')))) && ((local_14[6] == '0' && (local_14[7] == '1')))))) {
...

{
  ...
  while( true ) {
    ...
    local_1c = CONCAT13(local_14._2_1_,
                        CONCAT12(bVar2 ^ local_10 ^ local_14._1_1_,CONCAT11((char)local_14,bVar2 ^ local_10)));
    local_a = local_a >> 1;
    local_b = local_b + '\x01';
    if (local_b == '\b') {
      local_a = 0x80;
...

{
  ...
  for (local_10 = 0; local_10 < param_3; local_10 = local_10 + 1) {
    local_c = local_c + *(int *)(gAsic_Core_Nonce_Num + (((uint)param_1 * 0x100 + (uint)param_2) * 0x200 + local_10) * 4
                                );
  }
  return local_c;
}
...

{
  ...
  for (local_c = 0; local_c < 4; local_c = local_c + 1) {
    ...
    *(undefined1 *)((int)&gNotReadOutTemp + local_c) = 0;
    pthread_mutex_init((pthread_mutex_t *)(HW_check_mutex + local_c * 0x18),(pthread_mutexattr_t *)0x0);
    ...
    *(undefined4 *)(gSend_Work_Num + local_c * 4) = 0;
    for (local_10 = 0; local_10 < (uint)Conf._108_4_; local_10 = local_10 + 1) {
      ...
      for (local_14 = 0; local_14 < (uint)Conf._112_4_; local_14 = local_14 + 1) {
        *(undefined4 *)(gAsic_Core_Nonce_Num + ((local_c * 0x100 + local_10) * 0x200 + local_14) * 4) = 0;
        for (local_18 = 0; local_18 < (uint)Conf._64_4_; local_18 = local_18 + 1) {
          *(undefined4 *)(iVar1 + (local_14 * Conf._64_4_ + local_18) * 0xcc + (local_c + 0x2e) * 4 + 4) = 0;
        }
      }
    }
  }
...

{
  ...
  *(undefined4 *)(time_counter + (uint)bVar1 * 4) = 0;
  do {
    ...
    if ((*(char *)((int)&gIsReadTemp + (uint)bVar1) != '\0') && (*(char *)((int)&gIsOpenCoreEnd + (uint)bVar1) != '\0'))
    {
...

{
  ...
  printf("\n--- %s: real voltage = %d, temp_voltage = %.6f, Pic_Voltage = %d\n","set_voltage",local_14,local_10._4_4_,
         (undefined4)local_10,local_10._4_4_,(uint)bVar1);
  if (Conf._116_4_ == 0x6ba) {
  ...
  if (local_14 < (uint)Conf._108_4_) {
    if (local_18 < (uint)Conf._112_4_) {
      if (local_1c < (uint)Conf._64_4_) {
        iVar2 = *(int *)(cgpu + (local_14 + 0x20028) * 4) + (local_18 * Conf._64_4_ + local_1c) * 0xcc;
        iVar3 = *(int *)(iVar2 + 4);
        *(int *)(gReceive_Nonce_Num + (uint)param_1 * 4) = *(int *)(gReceive_Nonce_Num + (uint)param_1 * 4) + 1;
        if (local_20 == iVar3) {
          if (*(int *)(iVar2 + (param_1 + 0x2e) * 4 + 4) == 0) {
            *(int *)(iVar2 + (param_1 + 0x2e) * 4 + 4) = *(int *)(iVar2 + (param_1 + 0x2e) * 4 + 4) + 1;
            *(int *)(gValid_Nonce_Num + (uint)param_1 * 4) = *(int *)(gValid_Nonce_Num + (uint)param_1 * 4) + 1;
            *(int *)(gAsic_Core_Nonce_Num + (((uint)param_1 * 0x100 + local_14) * 0x200 + local_18) * 4) =
                 *(int *)(gAsic_Core_Nonce_Num + (((uint)param_1 * 0x100 + local_14) * 0x200 + local_18) * 4) + 1;
          }
          else {
            *(int *)(gRepeated_Nonce_Id + (uint)param_1 * 4) = *(int *)(gRepeated_Nonce_Id + (uint)param_1 * 4) + 1;
            *(int *)(iVar2 + (param_1 + 0x2e) * 4 + 4) = *(int *)(iVar2 + (param_1 + 0x2e) * 4 + 4) + 1;
          }
        }
        else {
          ...
          while ((local_28 < (int)(uint)*(byte *)((int)&gWork_Num_For_Hw_Check + (uint)param_1) &&
                 (local_24 = check_hw(gWorks_For_Hw_Check + (uint)param_1 * 0x7f8 + local_28 * 0xcc,local_20,param_2[4],
                                      0), local_24 != 0))) {
            local_28 = local_28 + 1;
          }
          pthread_mutex_unlock((pthread_mutex_t *)(HW_check_mutex + (uint)param_1 * 0x18));
          if (local_24 == 1) {
            *(int *)(gHw_Nonce_Num + (uint)param_1 * 4) = *(int *)(gHw_Nonce_Num + (uint)param_1 * 4) + 1;
            printf("%s: Find a HW. Chain%d ASIC%d Core%d : nonce = 0x%08x.\n","check_nonce",(uint)param_1,local_14,
                   local_18,local_20);
          }
        }
        uVar1 = 0;
...

{
  ...
  if (reg_value_buf[2] < 0x200) {
    ...
    *(byte *)((int)reg_value_buf + *reg_value_buf * 10 + 0x18) = *(byte *)((int)param_2 + (local_c - 1)) & 0x1f;
          ...
          if (local_48 != local_44) {
            ...
            while (local_20 <= local_14) {
              if ((*(char *)((int)local_3c + local_48) == -0x56) &&
                 (iVar3 = use_point_add_1(local_48,local_34), *(char *)((int)local_3c + iVar3) == 'U')) {
                for (local_1c = 0; local_1c < local_20; local_1c = local_1c + 1) {
                  *(undefined1 *)((int)local_40 + local_1c) = *(undefined1 *)((int)local_3c + local_48);
                ...
                while ((local_1c < local_20 - 1 &&
                  ...
                  printf("%s: Headers are not corret! Header0 = 0x%02x, Header1 = 0x%02x, Header2 = 0x%02x rp = %d\n",
                         "receive_func",(uint)bVar1,(uint)bVar2,(uint)*(byte *)((int)local_3c + iVar3),local_48);
                  local_1c = local_1c + 1;
                }
  ...
  for (local_14 = 0; local_14 < (uint)Conf._108_4_; local_14 = local_14 + 1) {
    ...
    for (local_18 = 0; local_18 < (uint)Conf._112_4_; local_18 = local_18 + 1) {
      for (local_1c = 0; local_1c < (uint)Conf._64_4_; local_1c = local_1c + 1) {
        ...
        *(int *)(gSend_Work_Num + (uint)local_25 * 4) = *(int *)(gSend_Work_Num + (uint)local_25 * 4) + 1;
        usleep(Conf._200_4_);
      }
    }
  }
  while (*(uint *)(gSend_Work_Num + (uint)local_25 * 4) < (uint)(Conf._108_4_ * Conf._112_4_ * Conf._64_4_)) {
...

{
  ...
  for (local_c = 0; local_c < (uint)Conf._112_4_; local_c = local_c + 1) {
    ...
    printf("core[%02d]=%02d\t",local_c,*(undefined4 *)(gAsic_Core_Nonce_Num + ((uint)param_1 * 0x20000 + local_c) * 4));
  }
  puts("\n\n");
  for (local_c = 0; local_c < (uint)Conf._112_4_; local_c = local_c + 1) {
    if (*(uint *)(gAsic_Core_Nonce_Num + ((uint)param_1 * 0x20000 + local_c) * 4) < (uint)Conf._64_4_) {
      local_14 = 0;
      ...
      for (local_10 = 0; local_10 < (uint)Conf._64_4_; local_10 = local_10 + 1) {
        if (*(int *)(uVar1 + (local_c * Conf._64_4_ + local_10) * 0xcc + (param_1 + 0x2e) * 4 + 4) == 0) {
          printf("%d  ",local_10);
        }
      }
      putchar(10);
  ...
  for (local_c = 0; local_c < (uint)Conf._112_4_; local_c = local_c + 1) {
    ...
    for (local_10 = 0; local_10 < (uint)Conf._64_4_; local_10 = local_10 + 1) {
      local_18 = local_18 + *(int *)(uVar1 + (local_c * Conf._64_4_ + local_10) * 0xcc + (param_1 + 0x2e) * 4 + 4);
    }
  ...
  puts("\n------------------------------------------------------------------------------------------------------\n");
  printf("Chain%d total valid nonce number: %d\n\n",(uint)param_1,*(undefined4 *)(gValid_Nonce_Num + (uint)param_1 * 4))
  ;
  ...
  printf("Chain%d HW number = %d\n\n",(uint)param_1,*(undefined4 *)(gHw_Nonce_Num + (uint)param_1 * 4));
  if (local_14 == 0) {
    puts("Pattern NG\n");
  }
  else {
...

{
  ...
  for (local_c = 0; local_c < (uint)Conf._108_4_; local_c = local_c + 1) {
    ...
    for (local_10 = 0; local_10 < (uint)Conf._112_4_; local_10 = local_10 + 1) {
      for (local_14 = 0; local_14 < (uint)Conf._64_4_; local_14 = local_14 + 1) {
        local_24 = local_24 +
                   *(int *)(*(int *)(cgpu + (local_c + 0x20028) * 4) + (local_10 * Conf._64_4_ + local_14) * 0xcc +
                            (param_1 + 0x2e) * 4 + 4);
      }
    }
  ...
  for (local_c = 0; local_c < (uint)Conf._108_4_; local_c = local_c + 1) {
    ...
    for (local_10 = 0; local_10 < (uint)Conf._112_4_; local_10 = local_10 + 1) {
      for (local_14 = 0; local_14 < (uint)Conf._64_4_; local_14 = local_14 + 1) {
        iVar3 = *(int *)(cgpu + (local_c + 0x20028) * 4) + (local_10 * Conf._64_4_ + local_14) * 0xcc;
  ...
  for (local_c = 0; local_c < (uint)Conf._108_4_; local_c = local_c + 1) {
    ...
    if (uVar1 <= (uint)(Conf._112_4_ * Conf._64_4_) && Conf._112_4_ * Conf._64_4_ - uVar1 != 0) {
      ...
      local_1c = 0;
      for (local_10 = 0; local_10 < (uint)Conf._112_4_; local_10 = local_10 + 1) {
        if (*(uint *)(gAsic_Core_Nonce_Num + (((uint)param_1 * 0x100 + local_c) * 0x200 + local_10) * 4) <
            (uint)Conf._64_4_) {
          local_1c = local_1c + 1;
          ...
          printf("core[%02d] = %d,      lost these nonce : ",local_10,
                 *(undefined4 *)(gAsic_Core_Nonce_Num + (((uint)param_1 * 0x100 + local_c) * 0x200 + local_10) * 4));
          for (local_14 = 0; local_14 < (uint)Conf._64_4_; local_14 = local_14 + 1) {
            if (*(int *)(iVar3 + (local_10 * Conf._64_4_ + local_14) * 0xcc + (param_1 + 0x2e) * 4 + 4) == 0) {
              printf("%d  ",local_14);
            }
          }
          putchar(10);
...
LAB_0001042e:
          ...
          *param_2 = (uint)local_20 | (uint)local_1d << 0x10 | (uint)local_1e << 8 | (uint)local_1f << 4;
          *param_3 = local_21;
          printf("--- %s: Want freq %f  real freq %f","get_pllparam_divider",SUB84((double)param_1,0),
          ...
          printf("--- %s: pll_vco %f, fbdiv %#x refdiv %#x postdiv1 %#x postdiv2 %#x, pll_divider %d ,{pll_value %#x}",
                 "get_pllparam_divider",SUB84((double)local_18,0),(int)((ulonglong)(double)local_18 >> 0x20),
                 (uint)local_1d,(uint)local_1e,(uint)local_1f,(uint)local_20,(uint)*param_3,*param_2);
          uVar3 = 0;
        }
        else {
          printf("--- %s: Don\'t find postdiv1 %d * postdiv2 %d = postdiv %d","get_pllparam_divider",(uint)local_1f,
...

{
  ...
  for (local_c = 0; local_18 = 0, local_c < 3; local_c = local_c + 1) {
    ...
    if (local_14 != 0) {
      enable_read_temperature_from_asic_chain(param_1,(gChain_Asic_Interval & 0xff) * (local_14 - 1 & 0xff) & 0xff);
      do {
        if (Conf._116_4_ == 0x6ba) {
...

{
  ...
  for (local_c = 0; local_14 = 0, local_c < 3; local_c = local_c + 1) {
    ...
    if (local_10 != 0) {
      enable_read_temperature_from_asic_chain(param_1,(gChain_Asic_Interval & 0xff) * (local_10 - 1 & 0xff) & 0xff);
      do {
        if (Conf._116_4_ == 0x6ba) {
...

{
  ...
  *(undefined1 *)((int)&gNotReadOutTemp + (uint)param_1) = 0;
  for (local_14 = 0; local_20 = 0, local_14 < 3; local_14 = local_14 + 1) {
    ...
    if (local_1c != 0) {
      enable_read_temperature_from_asic_chain(param_1,(gChain_Asic_Interval & 0xff) * (local_1c - 1 & 0xff) & 0xff);
      do {
        if (Conf._116_4_ == 0x6ba) {
  ...
  uVar1 = __udivsi3((((*(int *)(Sensor1_temp + (uint)param_1 * 4) + *(int *)(Sensor2_temp + (uint)param_1 * 4) +
                      *(int *)(Sensor3_temp + (uint)param_1 * 4)) - *(int *)(last_Sensor1_temp + (uint)param_1 * 4)) -
                    *(int *)(last_Sensor2_temp + (uint)param_1 * 4)) - *(int *)(last_Sensor3_temp + (uint)param_1 * 4),
                    gSensor_number);
  *(undefined4 *)(temp_change + (uint)param_1 * 4) = uVar1;
  if ((0 < *(int *)(temp_change + (uint)param_1 * 4)) || (*(int *)(temp_change + (uint)param_1 * 4) < 0)) {
    *(undefined4 *)(last_Sensor1_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor1_temp + (uint)param_1 * 4);
    *(undefined4 *)(last_Sensor2_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor2_temp + (uint)param_1 * 4);
    *(undefined4 *)(last_Sensor3_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor3_temp + (uint)param_1 * 4);
  }
  *(undefined4 *)(highest_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor1_temp + (uint)param_1 * 4);
  if (*(int *)(highest_temp + (uint)param_1 * 4) < *(int *)(Sensor2_temp + (uint)param_1 * 4)) {
    *(undefined4 *)(highest_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor2_temp + (uint)param_1 * 4);
  }
  if (*(int *)(highest_temp + (uint)param_1 * 4) < *(int *)(Sensor3_temp + (uint)param_1 * 4)) {
    *(undefined4 *)(highest_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor3_temp + (uint)param_1 * 4);
  }
  *(undefined4 *)(lowest_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor1_temp + (uint)param_1 * 4);
  if ((*(int *)(Sensor2_temp + (uint)param_1 * 4) < *(int *)(lowest_temp + (uint)param_1 * 4)) &&
     (*(int *)(Sensor2_temp + (uint)param_1 * 4) != 0)) {
    *(undefined4 *)(lowest_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor2_temp + (uint)param_1 * 4);
  }
  if ((*(int *)(Sensor3_temp + (uint)param_1 * 4) < *(int *)(lowest_temp + (uint)param_1 * 4)) &&
     (*(int *)(Sensor3_temp + (uint)param_1 * 4) != 0)) {
    *(undefined4 *)(lowest_temp + (uint)param_1 * 4) = *(undefined4 *)(Sensor3_temp + (uint)param_1 * 4);
  }
  if (*(int *)(gGlobalHighestTemp + (uint)param_1 * 4) < *(int *)(highest_temp + (uint)param_1 * 4)) {
    *(undefined4 *)(gGlobalHighestTemp + (uint)param_1 * 4) = *(undefined4 *)(highest_temp + (uint)param_1 * 4);
  }
...

{
  ...
  if (iVar2 != 0) {
    for (local_10 = 0; (int)local_10 < 6; local_10 = local_10 + 1) {
      local_9 = save_byte_to_eeprom((local_10 & 0xff) - 0x66 & 0xff,*(undefined1 *)((int)&local_18 + local_10));
      if (local_9 != '\x01') {
...
void write_lcd_no_memset(undefined4 param_1,undefined4 param_2,undefined4 param_3)
...

{
  ...
  if (((param_2 == 0) || (param_3 < 1)) || (param_1 == 0)) {
    ...
    for (local_14 = 0; local_14 < param_3 / 2; local_14 = local_14 + 1) {
      uVar1 = twoc2hex(*(undefined1 *)(param_2 + local_14 * 2),*(undefined1 *)(param_2 + local_14 * 2 + 1));
...

{
  ...
  while( true ) {
    ...
    local_20 = (uint *)(*(int *)(cgpu + (param_1 + 0x20028) * 4) + (param_4 * param_2 + local_18) * 0xcc);
    ...
    *(void **)(cgpu + (local_20 + 0x20028) * 4) = pvVar1;
    ...
    for (local_1c = 0; local_1c < (uint)Conf._112_4_; local_1c = local_1c + 1) {
      ...
      *(FILE **)(cgpu + iVar4 * 4) = pFVar2;
      ...
      iVar4 = local_20 * Conf._112_4_ + local_1c;
      uVar3 = get_work(local_20,local_1c,*(undefined4 *)(cgpu + (local_20 * Conf._112_4_ + local_1c) * 4),Conf._64_4_);
...
undefined4 set_PIC16F1704_flash_point32_ter(undefined1 param_1,undefined1 param_2,byte param_3,byte param_4)
...

{
  ...
  if ((local_1c[0] == 2) && (local_1c[1] == 1)) {
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%02x, read_back_data[1] = 0x%02x\n\n","send_data_to_PIC16F1704",
           (uint)local_1c[0],(uint)local_1c[1]);
    uVar3 = 0;
  }
  return uVar3;
}
...
undefined4 read_PIC16F1704_flash_point32_ter(undefined1 param_1,undefined1 param_2,byte *param_3,byte *param_4)

{
  ...
  if ((local_20._1_1_ == 8) && ((char)local_20 == '\x06')) {
    ...
    if (((byte)((ushort)local_14 >> 8) == (byte)local_1c) && ((byte)local_14 == local_1c._1_1_)) {
      ...
      *param_4 = local_20._3_1_;
      ...
      printf("\n--- %s failed! read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x, read_back_data[4] = 0x%x, read_back_data[5] = 0x%x\n\n"
             ,"read_PIC16F1704_flash_point32_ter",local_20 & 0xff,8,(uint)local_20._2_1_,(uint)local_20._3_1_,
    ...
    printf("\n--- %s failed! read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x, read_back_data[4] = 0x%x, read_back_data[5] = 0x%x\n\n"
           ,"read_PIC16F1704_flash_point32_ter",local_20 & 0xff,(uint)local_20._1_1_,(uint)local_20._2_1_,
...

{
  ...
  printf("--- %s: read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x,         read_back_data[4] = 0x%x, read_back_data[5] = 0x%x, read_back_data[6] = 0x%x, read_back_data[7] = 0x%x,         read_back_data[8] = 0x%x, read_back_data[9] = 0x%x, read_back_data[10] = 0x%x, read_back_data[11] = 0x%x,         read_back_data[12] = 0x%x, read_back_data[13] = 0x%x, read_back_data[14] = 0x%x, read_back_data[15] = 0x%x,         read_back_data[16] = 0x%x, read_back_data[17] = 0x%x, read_back_data[18] = 0x%x, read_back_data[19] = 0x%x\n"
         ,"read_PIC16F1704_flash_data",local_44 & 0xff,local_44 >> 8 & 0xff,uVar4,uVar18,uVar5,uVar6,uVar7,uVar19,uVar8,
         uVar9,uVar10,uVar20,uVar11,uVar12,uVar13,uVar21,uVar14,uVar15,uVar16,uVar22);
  usleep(100000);
  if ((local_44._1_1_ == '\x03') && ((local_44 & 0xff) == 0x14)) {
    local_2c = (byte)local_44 + 3 + (ushort)local_44._2_1_ + (ushort)local_44._3_1_ + (ushort)(byte)local_40 +
               (ushort)local_40._1_1_ + (ushort)local_40._2_1_ + (ushort)local_40._3_1_ + (ushort)(byte)local_3c +
               (ushort)local_3c._1_1_ + (ushort)local_3c._2_1_ + (ushort)local_3c._3_1_ + (ushort)(byte)local_38 +
               (ushort)local_38._1_1_ + (ushort)local_38._2_1_ + (ushort)local_38._3_1_ + (ushort)(byte)local_34 +
               (ushort)local_34._1_1_;
    if (((char)(local_2c >> 8) == local_34._2_1_) && (uVar3 = (uint)(byte)local_2c, uVar3 == local_34 >> 0x18)) {
      for (local_29 = 0; local_29 < 0x10; local_29 = local_29 + 1) {
        bVar1 = *(byte *)((int)&local_44 + local_29 + 2);
        uVar3 = (uint)bVar1;
        *(byte *)(param_3 + (uint)local_29) = bVar1;
      }
      printf("\n--- %s ok\n\n","read_PIC16F1704_flash_data",uVar3,(uint)local_29,uVar4,uVar18,uVar5,uVar6,uVar7,uVar19,
             uVar8,uVar9,uVar10,uVar20,uVar11,uVar12,uVar13,uVar21,uVar14,uVar15,uVar16,uVar22);
      uVar17 = 1;
    }
    else {
      printf("\n--- %s failed! crc = 0x%04x\n\n","read_PIC16F1704_flash_data",(uint)local_2c,(uint)local_2c,uVar4,uVar18
             ,uVar5,uVar6,uVar7,uVar19,uVar8,uVar9,uVar10,uVar20,uVar11,uVar12,uVar13,uVar21,uVar14,uVar15,uVar16,uVar22
            );
      uVar17 = 0;
    }
  }
...

{
  ...
  printf("--- %s: read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x,        read_back_data[4] = 0x%x, read_back_data[5] = 0x%x, read_back_data[6] = 0x%x, read_back_data[7] = 0x%x,        read_back_data[8] = 0x%x, read_back_data[9] = 0x%x, read_back_data[10] = 0x%x, read_back_data[11] = 0x%x,        read_back_data[12] = 0x%x, read_back_data[13] = 0x%x, read_back_data[14] = 0x%x, read_back_data[15] = 0x%x\n"
         ,"read_hash_id_PIC16F1704",local_40 & 0xff,local_40 >> 8 & 0xff,uVar4,uVar15,uVar5,uVar6,uVar7,uVar16,uVar8,
         uVar9,uVar10,uVar17,uVar11,uVar12,uVar13,uVar18);
  if ((local_40._1_1_ == '\x13') && ((local_40 & 0xff) == 0x10)) {
    local_2c = (byte)local_40 + 0x13 + (ushort)local_40._2_1_ + (ushort)local_40._3_1_ + (ushort)(byte)local_3c +
               (ushort)local_3c._1_1_ + (ushort)local_3c._2_1_ + (ushort)local_3c._3_1_ + (ushort)(byte)local_38 +
               (ushort)local_38._1_1_ + (ushort)local_38._2_1_ + (ushort)local_38._3_1_ + (ushort)(byte)local_34 +
               (ushort)local_34._1_1_;
    if (((char)(local_2c >> 8) == local_34._2_1_) && (uVar3 = (uint)(byte)local_2c, uVar3 == local_34 >> 0x18)) {
      ...
      printf("\n--- %s ok\n\n","read_hash_id_PIC16F1704",uVar3,(uint)local_29,uVar4,uVar15,uVar5,uVar6,uVar7,uVar16,
             uVar8,uVar9,uVar10,uVar17,uVar11,uVar12,uVar13,uVar18);
      uVar14 = 1;
    }
    else {
      printf("\n--- %s failed! crc = 0x%04x\n\n","read_hash_id_PIC16F1704",(uint)local_2c,(uint)local_2c,uVar4,uVar15,
             uVar5,uVar6,uVar7,uVar16,uVar8,uVar9,uVar10,uVar17,uVar11,uVar12,uVar13,uVar18);
      uVar14 = 0;
    }
  }
  else {
...

{
  ...
  if ((local_20._1_1_ == '\x17') && ((local_20 & 0xff) == 5)) {
    ...
    if (((char)(local_14 >> 8) == local_20._3_1_) && ((byte)local_14 == local_1c)) {
      *param_3 = local_20._2_1_;
      printf("\n--- %s ok, version = 0x%02x\n\n","get_PIC16F1704_software_version",(uint)*param_3,(uint)*param_3,uVar2,
             uVar5,uVar3);
      uVar4 = 1;
    }
    else {
      printf("\n--- %s failed! crc = 0x%04x\n\n","get_PIC16F1704_software_version",(uint)local_14,(uint)local_14,uVar2,
             uVar5,uVar3);
      uVar4 = 0;
    }
  }
...

{
  ...
  if ((local_20._1_1_ == '\x18') && ((local_20 & 0xff) == 5)) {
    ...
    if (((char)(local_14 >> 8) == local_20._3_1_) && ((byte)local_14 == local_1c)) {
      *param_3 = local_20._2_1_;
      printf("\n--- %s ok, voltage = 0x%02x\n\n","get_PIC16F1704_voltage",(uint)*param_3,(uint)*param_3,uVar2,uVar5,
             uVar3);
      uVar4 = 1;
    }
    else {
      printf("\n--- %s failed! crc = 0x%04x\n\n","get_PIC16F1704_voltage",(uint)local_14,(uint)local_14,uVar2,uVar5,
             uVar3);
      uVar4 = 0;
    }
  }
...

{
  ...
  printf("--- %s: read_back_data[0] = 0x%x, read_back_data[1] = 0x%x, read_back_data[2] = 0x%x, read_back_data[3] = 0x%x,         read_back_data[4] = 0x%x, read_back_data[5] = 0x%x, read_back_data[6] = 0x%x, read_back_data[7] = 0x%x,         read_back_data[8] = 0x%x, read_back_data[9] = 0x%x, read_back_data[10] = 0x%x, read_back_data[11] = 0x%x\n"
         ,"read_temperature_offset_PIC16F1704",local_34 & 0xff,local_34 >> 8 & 0xff,uVar3,uVar12,uVar4,uVar5,uVar6,
         uVar13,uVar7,uVar8,uVar9,uVar14);
  if ((local_34._1_1_ == '#') && ((local_34 & 0xff) == 0xc)) {
    local_24 = (byte)local_34 + 0x23 + (ushort)local_34._2_1_ + (ushort)local_34._3_1_ + (ushort)(byte)local_30 +
               (ushort)local_30._1_1_ + (ushort)local_30._2_1_ + (ushort)local_30._3_1_ + (ushort)(byte)local_2c +
               (ushort)local_2c._1_1_;
    if (((char)(local_24 >> 8) == local_2c._2_1_) && (uVar10 = (uint)(byte)local_24, uVar10 == local_2c >> 0x18)) {
      for (local_21 = 0; local_21 < 8; local_21 = local_21 + 1) {
        bVar1 = *(byte *)((int)&local_34 + local_21 + 2);
        uVar10 = (uint)bVar1;
        *(byte *)(param_3 + (uint)local_21) = bVar1;
      }
      printf("\n--- %s ok\n\n","read_temperature_offset_PIC16F1704",uVar10,(uint)local_21,uVar3,uVar12,uVar4,uVar5,uVar6
             ,uVar13,uVar7,uVar8,uVar9,uVar14);
      uVar11 = 1;
    }
    else {
      printf("\n--- %s failed! crc = 0x%04x\n\n","read_temperature_offset_PIC16F1704",(uint)local_24,(uint)local_24,
             uVar3,uVar12,uVar4,uVar5,uVar6,uVar13,uVar7,uVar8,uVar9,uVar14);
      uVar11 = 0;
    }
  }
  else {
...

{
  ...
  if (local_30 == (FILE *)0x0) {
    ...
    fseek(local_30,0,0);
    memset(&uStack_13b8,0,5000);
    local_28 = (((uint)local_23 * 0x100 + (uint)local_24) - ((uint)local_21 * 0x100 + (uint)local_22)) + 1;
  ...
  if ((local_20._1_1_ == '%') && ((local_20 & 0xff) == 6)) {
    ...
    if (((char)(local_14 >> 8) == (byte)local_1c) && ((char)local_14 == local_1c._1_1_)) {
      *param_3 = CONCAT11(local_20._2_1_,local_20._3_1_);
      printf("\n--- %s ok, freq = %d\n\n","get_PIC16F1704_freq",(uint)*param_3,(uint)*param_3,uVar2,uVar6,uVar3,uVar4);
      uVar5 = 1;
    }
    else {
      printf("\n--- %s failed! crc = 0x%04x\n\n","get_PIC16F1704_freq",(uint)local_14,(uint)local_14,uVar2,uVar6,uVar3,
             uVar4);
      uVar5 = 0;
    }
  }
...
byte znyq_set_iic(undefined4 param_1,undefined4 param_2,char param_3,undefined4 param_4,undefined1 param_5)
  ...
  while (local_12 < 3) {
    ...
    for (local_11 = 0; local_11 < param_4; local_11 = local_11 + 1) {
      ...
      *(undefined1 *)(param_3 + (uint)local_11) = uVar1;
      printf("%s, reply_buf[%d]=%02x\n","power_send_cmd",(uint)local_11,(uint)*(byte *)(param_3 + (uint)local_11));
    }
...

{
  ...
  printf("%s, %02x, %02x, %02x, %02x, %02x, %02x, %02x, %02x\n","power_set_da_value",0x55,0xaa,6,0x83,
         (uint3)local_20 & 0xff,0,(uint)(byte)local_1a,(uint)bVar1);
...
void sph_enc64be_aligned(undefined8 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
      ...
      if (local_24 == 0x80) {
        ...
        for (local_104 = 0; local_104 < 0x10; local_104 = local_104 + 1) {
          ...
          local_88 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 4))) + uVar2 + local_a8;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0xc) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 8))) + local_90 + local_b0;
          ...
          local_90 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 8) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0xc))) + uVar2 + local_b0;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x14) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x10))) + local_98 + local_b8;
          ...
          local_98 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x10) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x14))) + uVar2 + local_b8;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x1c) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x18))) + local_a0 + local_c0;
          ...
          local_a0 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x18) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x1c))) + uVar2 + local_c0;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x24) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x20))) + local_88 + local_b0;
          ...
          local_88 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x20) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x24))) + uVar2 + local_b0;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x2c) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x28))) + local_90 + local_b8;
          ...
          local_90 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x28) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x2c))) + uVar2 + local_b8;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x34) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x30))) + local_98 + local_c0;
          ...
          local_98 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x30) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x34))) + uVar2 + local_c0;
          ...
          uVar2 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x3c) * 8) ^
                  *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x38))) + local_a0 + local_a8;
          ...
          local_a0 = (*(uint *)(CB + *(int *)(sigma + local_104 * 0x40 + 0x38) * 8) ^
                     *(uint *)(&local_1a8 + *(int *)(sigma + local_104 * 0x40 + 0x3c))) + uVar2 + local_a8;
...
void sph_blake224_addbits_and_close(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
void sph_blake256_addbits_and_close(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
void sph_blake384_addbits_and_close(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
...
void sph_blake512_addbits_and_close(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
          ...
          if (local_214 == 0) {
            ...
            for (; local_214 != 0; local_214 = local_214 >> 1) {
              if ((local_214 & 1) != 0) {
                ...
                *(int *)(capability +
                        (capability._0_4_ * 0x12 + *(int *)(capability + capability._0_4_ * 0x48 + 8) + 2) * 4 + 4) =
                     local_c;
      ...
      if (local_10 < 0) {
        ...
        if (iVar1 == 0) {
          iVar1 = i2c_ioctl(local_10,0x703,
                            (uint)*(byte *)((int)param_1 + 7) << 1 | (uint)*(byte *)((int)param_1 + 6) << 4);
          if (iVar1 == 0) {
...
undefined4 iic_read_reg(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
...
undefined4 iic_write_reg(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
  ...
  if (iVar1 == 0) {
    ...
    for (local_14 = 0; local_14 < (int)local_20; local_14 = local_14 + 1) {
      local_18 = (uint)abStack_124[local_14 * 4 + 3] |
                 (uint)abStack_124[local_14 * 4] << 0x18 | (uint)abStack_124[local_14 * 4 + 1] << 0x10 |
    ...
    if (local_20 != 0) {
      if (local_20 == 2) {
        local_18 = (uint)abStack_124[local_14 * 4 + 1] << 0x10 | (uint)abStack_124[local_14 * 4] << 0x18;
      }
      else if (local_20 == 3) {
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 1) {
      local_14 = local_18;
      local_10 = ((uint)local_18[1] >> 1 & 7) << 0x10 | *local_18 << 0x1a | ((uint)local_18[1] >> 4) << 0x14 | 0x2000000
      ;
      for (local_c = 0; local_c < param_3; local_c = local_c + 1) {
    ...
    if (iVar1 == 1) {
      ...
      for (local_c = 0; local_c < param_3; local_c = local_c + 1) {
        local_10 = (uint)*(byte *)(param_2 + local_c) |
                   *local_14 << 0x1a | ((uint)local_14[1] >> 4) << 0x14 | ((uint)local_14[1] >> 1 & 7) << 0x10;
        iVar1 = wait4i2c_ready();
        if (iVar1 == 0) {
          free(local_18);
  ...
  if (param_3 == 1) {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 1) {
        ...
        for (local_c = 0; local_c < param_5; local_c = local_c + 1) {
          if (*local_14 == 1) {
            local_10 = ((uint)local_14[1] >> 1 & 7) << 0x10 | *local_14 << 0x1a | ((uint)local_14[1] >> 4) << 0x14 |
                       0x2000000;
          }
          else {
...

{
  ...
  if ((local_1c == (int *)0x0) || (*local_1c != 0)) {
    ...
    if ((local_20 == (int *)0x0) || (*local_20 != 1)) {
      ...
      local_14 = 0;
      while ((uVar1 = local_14, uVar2 = json_array_size(local_20), uVar1 < uVar2 && ((int)local_14 < 0x10))) {
      ...
      if ((local_20 == (int *)0x0) || (*local_20 != 1)) {
        ...
        local_18 = 0;
        while ((uVar1 = local_18, uVar2 = json_array_size(local_20), uVar1 < uVar2 && ((int)local_18 < 6))) {
...

{
  ...
  if (conf_loaded == 0) {
    ...
    local_c = 0;
    while ((local_c < 0x10 &&
           ((((*(int *)(chains + local_c * 0x10) != 0xff || (*(int *)(chains + local_c * 0x10 + 4) != 0xff)) ||
             (*(int *)(chains + local_c * 0x10 + 8) != 0xff)) || (*(int *)(chains + local_c * 0x10 + 0xc) != 0xff))))) {
      local_c = local_c + 1;
    }
  }
  return local_c;
...
undefined4 insert_c_map(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)
...
undefined4 insert_c_rb(undefined4 *param_1,undefined4 param_2,undefined4 param_3,int param_4,undefined4 param_5)
...

{
  ...
  if ((undefined4 *)param_2[1] == param_1 + 1) {
    ...
    if (puVar1 == param_2) {
      ...
      local_18 = param_2;
      for (local_c = (undefined4 *)param_2[2]; (param_1 + 1 != local_c && ((undefined4 *)local_c[1] == local_18));
...

{
  ...
  if ((iVar1 != 1) && (iVar1 = debug_node_color(param_1,param_2), iVar1 != 0)) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("debug_node_color(pTree,n) == 1 || debug_node_color(pTree,n) == 0","3rdparty/cstl/src/c_rb.c",0x1df,
...

{
  ...
  if (iVar1 != 0) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("debug_node_color(pTree,root) == 0","3rdparty/cstl/src/c_rb.c",0x1e6,"debug_verify_property_2");
  }
  return;
}
...

{
  ...
  if (iVar1 == 1) {
    ...
    if (iVar1 != 0) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("debug_node_color(pTree,n->left) == 0","3rdparty/cstl/src/c_rb.c",0x1ef,"debug_verify_property_4");
    }
    iVar1 = debug_node_color(param_1,param_2[1]);
    if (iVar1 != 0) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("debug_node_color(pTree,n->right) == 0","3rdparty/cstl/src/c_rb.c",0x1f0,"debug_verify_property_4");
    }
    iVar1 = debug_node_color(param_1,param_2[2]);
    if (iVar1 != 0) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("debug_node_color(pTree,n->parent) == 0","3rdparty/cstl/src/c_rb.c",0x1f1,"debug_verify_property_4")
      ;
    }
  }
  if ((undefined4 *)(param_1 + 4) != param_2) {
  ...
  if ((undefined4 *)(param_1 + 4) == param_2) {
    if (*param_4 == -1) {
      *param_4 = local_14;
                    ...
                    /* WARNING: Subroutine does not return */
      __assert_fail("black_count == *path_black_count","3rdparty/cstl/src/c_rb.c",0x205,"debug_verify_property_5_helper"
                   );
    }
  }
  else {
...
undefined4 dump_to_strbuffer(undefined4 param_1,undefined4 param_2,undefined4 param_3)
...
LAB_000230c4:
  ...
  if (((((local_24 != 0x5c) && (local_24 != 0x22)) && (0x1f < (int)local_24)) &&
     ...
     ((pcVar1 = local_10, (param_4 & 0x40) == 0 || (pcVar1 = local_10, (int)local_24 < 0x80)))) goto LAB_00023114;
LAB_00023124:
  if ((local_c != local_3c) && (iVar2 = (*param_2)(local_3c,(int)local_c - (int)local_3c,param_3), iVar2 != 0)) {
    return 0xffffffff;
  }
  if (local_10 == local_c) {
            ...
            if (((param_2 & 0x80) == 0) && ((param_2 & 0x100) == 0)) {
              ...
              if (local_54 != (void *)0x0) {
                ...
                for (local_24 = 0; local_24 < local_50; local_24 = local_24 + 1) {
                  ...
                  iVar2 = (*param_4)(local_1c,local_20,param_5);
                  if ((iVar2 != 0) || (iVar2 = do_dump(local_5c,param_2,param_3 + 1,param_4,param_5), iVar2 != 0)) {
                    jsonp_free(local_54);
                    goto LAB_00023954;
                  }
                  if (local_24 < local_50 - 1) {
                    iVar2 = (*param_4)(&DAT_0002ce6c,1,param_5);
                    if ((iVar2 != 0) || (iVar2 = dump_indent(param_2,param_3 + 1,1,param_4,param_5), iVar2 != 0)) {
                      jsonp_free(local_54);
                      goto LAB_00023954;
                    }
                  }
...
undefined4 json_dumpf(undefined4 param_1,undefined4 param_2,undefined4 param_3)
...

{
  ...
  if (iVar1 == 0) {
    local_c = *param_2;
    while( true ) {
      if ((*(int *)(local_c + -4) == param_4) && (iVar1 = strcmp((char *)(local_c + 0x10),param_3), iVar1 == 0)) {
  ...
  if ((param_2 != 0xffffffff) && (param_2 != 0xfffffffe)) {
    ...
    *(int *)(param_1 + 0x10) = *(int *)(param_1 + 0x10) + -1;
    if (*(byte *)(param_1 + *(int *)(param_1 + 0x10) + 8) != param_2) {
                    /* WARNING: Subroutine does not return */
      __assert_fail("stream->buffer[stream->buffer_pos] == c","3rdparty/jansson-2.6/src/load.c",0xe2,"stream_unget");
    }
  }
  return;
}
  ...
  while (local_c != 0x22) {
    ...
    if (local_c == 0x5c) {
      ...
      if (local_c == 0x75) {
        ...
        if (((((local_c != 0x22) && (local_c != 0x5c)) && (local_c != 0x2f)) && ((local_c != 0x62 && (local_c != 0x66)))
    ...
    *piVar1 = 0;
    ...
    if (*piVar1 != 0x22) {
      if (local_c + *(int *)(param_1 + 0x2c) != local_1c) {
                    /* WARNING: Subroutine does not return */
        __assert_fail("end == saved_text + lex->saved_text.length","3rdparty/jansson-2.6/src/load.c",0x206,
                      "lex_scan_number");
      }
...

{
  ...
  if (local_c == -1) {
    ...
    *(undefined4 *)(param_1 + 0x34) = 0xffffffff;
    ...
    if ((((local_c == 0x7b) || (local_c == 0x7d)) || ((local_c == 0x5b || ((local_c == 0x5d || (local_c == 0x3a)))))) ||
       (local_c == 0x2c)) {
...

{
  ...
  lex_scan(param_1,param_3);
  if ((((param_2 & 4) == 0) && (*(int *)(param_1 + 0x34) != 0x5b)) && (*(int *)(param_1 + 0x34) != 0x7b)) {
...

{
  ...
  *piVar1 = 0;
  ...
  if ((char *)(*param_1 + param_1[1]) != local_14) {
                    /* WARNING: Subroutine does not return */
    __assert_fail("end == strbuffer->value + strbuffer->length","3rdparty/jansson-2.6/src/strconv.c",0x46,"jsonp_strtod"
                 );
  }
  piVar1 = __errno_location();
    ...
    if (param_2 <= local_c) {
      if ((int)local_10 < 0x110000) {
        if (((int)local_10 < 0xd800) || (0xdfff < (int)local_10)) {
          if ((((param_2 == 2) && ((int)local_10 < 0x80)) || ((param_2 == 3 && ((int)local_10 < 0x800)))) ||
...

{
  ...
  if (iVar1 == 0) {
    ...
    for (local_c = json_object_iter(param_1); local_c != 0; local_c = json_object_iter_next(param_1,local_c)) {
...
{
  memmove((void *)(*(int *)(param_1 + 0x10) + param_2 * 4),(void *)(*(int *)(param_1 + 0x10) + param_3 * 4),param_4 << 2
         );
  return;
}
  ...
  if (param_1 == (int *)0x0) {
    ...
    if ((param_1 == (int *)0x0) || (*param_1 != 1)) {
      if ((param_1 == (int *)0x0) || (*param_1 != 2)) {
        if ((param_1 == (int *)0x0) || (*param_1 != 3)) {
          if ((param_1 == (int *)0x0) || (*param_1 != 4)) {
            if ((((param_1 == (int *)0x0) || (*param_1 != 5)) && ((param_1 == (int *)0x0 || (*param_1 != 6)))) &&
...
void jsonp_error_set(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,undefined4 param_5)

{
  jsonp_error_vset(param_1,param_2,param_3,param_4,param_5,&stack0x00000004);
  return;
}
...
void jsonp_error_vset(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,char *param_5,
...

{
  ...
  uVar1 = (*(code *)(&UNK_00027998 + (0x1f - (LZCOUNT(param_2) - LZCOUNT(param_1))) * 0x10))(param_1,param_2,0);
  return uVar1;
}
...
LAB_000280d4:
  ...
  if ((int)uVar11 < 0x21) {
    ...
    uVar6 = uVar3 + uVar5;
    uVar4 = uVar4 + CARRY4(uVar10,param_3) + ((int)uVar7 >> (uVar11 & 0xff)) + (uint)CARRY4(uVar3,uVar5);
  }
  else {
...
LAB_00027fa0:
    ...
    return CONCAT44(uVar11 + uVar10 * 0x100000 + (uint)CARRY4(uVar6,(uint)bVar14) | param_2,uVar6 + bVar14);
  }
...
LAB_00028018:
  ...
  if ((int)uVar6 < 0x1f) {
    ...
    uVar6 = uVar6 + 1;
    return CONCAT44(param_2 | uVar9 >> (uVar6 & 0xff),uVar7 >> (uVar6 & 0xff) | uVar9 << (0x20 - uVar6 & 0xff));
  }
...
LAB_000280d4:
  ...
  if ((int)uVar10 < 0x21) {
    ...
    uVar12 = uVar3 + uVar4;
    uVar9 = uVar9 + CARRY4(uVar8,param_3) + ((int)uVar5 >> (uVar10 & 0xff)) + (uint)CARRY4(uVar3,uVar4);
  }
  else {
...
LAB_00027fa0:
    ...
    return CONCAT44(uVar10 + uVar8 * 0x100000 + (uint)CARRY4(uVar12,(uint)bVar14) | param_2,uVar12 + bVar14);
  }
...
LAB_00028018:
  ...
  if ((int)uVar10 < 0x1f) {
    ...
    uVar10 = uVar10 + 1;
    return CONCAT44(param_2 | uVar7 >> (uVar10 & 0xff),uVar5 >> (uVar10 & 0xff) | uVar7 << (0x20 - uVar10 & 0xff));
  }
...
LAB_00028018:
  ...
  if (iVar3 == 0 || iVar3 < 0 != SCARRY4(uVar2 - 0x1f,0xc)) {
    uVar2 = uVar2 + 1;
    return CONCAT44(param_1 >> (uVar2 & 0xff),uVar1 >> (uVar2 & 0xff) | param_1 << (0x20 - uVar2 & 0xff));
  }
...
LAB_00028018:
  ...
  if (iVar4 == 0 || iVar4 < 0 != SCARRY4(uVar3 - 0x1f,0xc)) {
    uVar3 = uVar3 + 1;
    return CONCAT44(uVar6 | uVar2 >> (uVar3 & 0xff),uVar1 >> (uVar3 & 0xff) | uVar2 << (0x20 - uVar3 & 0xff));
  }
  return CONCAT44(param_1,uVar1 >> (0x20 - (0xcU - iVar4) & 0xff) | uVar2 << (0xcU - iVar4 & 0xff)) & 0x80000000ffffffff
  ;
}
...
LAB_00028018:
  ...
  if ((int)uVar4 < 0x1f) {
    ...
    uVar4 = uVar4 + 1;
    return CONCAT44(uVar1 | uVar5 >> (uVar4 & 0xff),uVar2 >> (uVar4 & 0xff) | uVar5 << (0x20 - uVar4 & 0xff));
  }
...
LAB_00027fa0:
    ...
    return CONCAT44(uVar3 + iVar7 * 0x100000 + (uint)CARRY4(param_1,(uint)bVar11) | uVar8,param_1 + bVar11);
  }
...
LAB_00028018:
  ...
  if (iVar7 == 0 || iVar7 < 0 != SCARRY4(uVar3 - 0x1f,0xc)) {
    uVar3 = uVar3 + 1;
    return CONCAT44(uVar8 | uVar4 >> (uVar3 & 0xff),uVar2 >> (uVar3 & 0xff) | uVar4 << (0x20 - uVar3 & 0xff));
  }
  return CONCAT44(param_2,uVar2 >> (0x20 - (0xcU - iVar7) & 0xff) | uVar4 << (0xcU - iVar7 & 0xff)) & 0x80000000ffffffff
  ;
}
