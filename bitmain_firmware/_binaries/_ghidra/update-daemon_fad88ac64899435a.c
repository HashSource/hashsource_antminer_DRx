  ...
  if (pcVar1 == (char *)0x0) {
    ...
    if (pcVar6 == (char *)0x0) {
      ...
      if (iVar2 == -1) {
        ...
        __assert_fail("sockfd_server != -1","update-daemon.c",0xa2,"ProcessServer");
      }
      local_38._0_2_ = 2;
      local_38[2] = '\0';
      local_38[3] = '\0';
      ...
      do {
        ...
        iVar5 = pthread_create((pthread_t *)(local_44 + 2),(pthread_attr_t *)0x0,FUN_00010c8c,local_44);
      } while (iVar5 != -1);
      fwrite("pthread_create error!\n",1,0x16,stderr);
      iVar2 = shutdown(iVar2,1);
      if (iVar2 == -1) {
                    /* WARNING: Subroutine does not return */
        __assert_fail("ret != -1","update-daemon.c",0xcc,"ProcessServer");
      }
...

{
  ...
  __libc_start_main(FUN_00010930,in_stack_00000000,&stack0x00000004,0x10fd1,&DAT_0001100d,param_1);
                    /* WARNING: Subroutine does not return */
  abort();
}
...
void FUN_00010fd0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
