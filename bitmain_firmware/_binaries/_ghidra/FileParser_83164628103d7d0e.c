...

{
  ...
  __libc_start_main(FUN_00011f08,in_stack_00000000,&stack0x00000004,0x12275,&DAT_000122b1,param_1);
        ...
        if ((param_6 == '\0') || (printf("content:%x\n",(uint)local_2a), (local_2a & 0xfe00) == 0xfe00)) {
          ...
          if (local_9 == param_3[0x518]) {
            ...
            for (local_18 = 0; local_18 < (int)(uint)local_9; local_18 = local_18 + 1) {
              local_58 = (uint)(byte)param_3[local_18 * 5 + 0x51e] << 0x18 |
            ...
            if (local_14 == local_24) {
              ...
              if (local_34 == (FILE *)0x0) {
                ...
                if (local_3c == 0) {
                  local_40 = fopen64("/usr/bin/fw_version","w");
                  if (local_40 != (FILE *)0x0) {
                    fwrite(param_3 + 0xd,1,8,local_40);
                    fclose(local_40);
                  }
                  if (param_4 != '\0') {
                    local_44 = fopen64("/tmp/tmpfw/miner.pem","w");
                    if (local_44 == (FILE *)0x0) {
                      puts("Dump Miner.pem Failed!\r");
                      return 0xf;
                    }
                    fwrite(param_3 + 0x18,1,local_38,local_44);
                    fclose(local_44);
                    local_44 = fopen64("/tmp/tmpfw/miner.pem.sig","w");
                    if (local_44 == (FILE *)0x0) {
                      puts("Dump Miner.pem.sig Failed!\r");
                      return 0x10;
                    }
                    fwrite(param_3 + 0x418,1,0x100,local_44);
                    fclose(local_44);
                  }
                  ...
                  for (local_1c = 0; local_1c < (int)(uint)local_9; local_1c = local_1c + 1) {
                    local_54 = (uint)(byte)param_3[local_1c * 5 + 0x51e] << 0x18 |
                               (uint)(byte)param_3[local_1c * 5 + 0x51f] << 0x10 |
                               (uint)(byte)param_3[local_1c * 5 + 0x520] << 8 |
                               (uint)(byte)param_3[local_1c * 5 + 0x521];
                    FUN_00010de8(local_28,local_54,auStack_8e0 + (local_1c + 1) * 0x20,param_3[local_1c * 5 + 0x51d],0,
                                 param_4);
                  }
                  ...
                  local_48 = (BIO *)0x0;
                  local_4c = (RSA *)0x0;
                  local_48 = BIO_new_mem_buf(param_3 + 0x18,0x400);
                  local_4c = PEM_read_bio_RSA_PUBKEY(local_48,(RSA **)0x0,(undefined1 *)0x0,(void *)0x0);
                  if (local_4c == (RSA *)0x0) {
                    uVar1 = ERR_get_error();
                    pcVar2 = ERR_error_string(uVar1,(char *)0x0);
                    printf("OpenSSL error: %s\n",pcVar2);
                    ...
                    local_50 = RSA_verify(0x2a0,local_a70,0x20,(uchar *)&local_a50,0x100,local_4c);
                    if (local_4c != (RSA *)0x0) {
                      RSA_free(local_4c);
                    }
                    if (local_48 != (BIO *)0x0) {
...
void FUN_00012274(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)
