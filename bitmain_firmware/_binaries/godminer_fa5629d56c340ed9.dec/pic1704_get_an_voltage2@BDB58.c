int __fastcall pic1704_get_an_voltage2(char a1, int a2)
{
  ...
  {
    LOWORD(v6) = 27280;
    HIWORD(v6) = (unsigned int)&unk_175560 >> 16;
    LOWORD(v11) = 24916;
    v7 = *v6;
    v8 = v6[1];
    v9 = v6[2];
    ...
    zlog(*v11, v15, 165, "pic1704_get_an_voltage2", 23, 473, 20, v38);
    snprintf(
      (char *)&s,
      0x800u,
      "an0 = %f, an2 %f, an6 %f.",
    ...
    V_UNLOCK();
    LOWORD(v16) = 26524;
    HIWORD(v16) = (unsigned int)&unk_17526C >> 16;
    zlog(*v11, v16, 165, "pic1704_get_an_voltage2", 23, 474, 20, v38);
    if ( a2 && ((v17 = (double)v29 * 3.3 * 0.0009765625, v2 > v17) || v3 < v17) )
    {
      LOWORD(v18) = 27340;
      HIWORD(v18) = (unsigned int)&unk_17559C >> 16;
      v19 = *v18;
      v20 = v18[1];
      v21 = v18[2];
      v22 = v18[3];
      ...
      V_UNLOCK();
      LOWORD(v26) = 26524;
      HIWORD(v26) = (unsigned int)&unk_17526C >> 16;
      return zlog(*v11, v26, 165, "pic1704_get_an_voltage2", 23, 480, 20, v38);
    }
    else
    {
      return sub_BCB30(v28);
    }
  }
  return result;
}
