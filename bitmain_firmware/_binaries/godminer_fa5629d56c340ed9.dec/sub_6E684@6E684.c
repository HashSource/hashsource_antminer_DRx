int __fastcall sub_6E684(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  int v8; // r4
  int v12; // r9
  int v13; // r3
  ...
  *(_BYTE *)(a3 + 65) = v12;
  *(_BYTE *)(a3 + 64) = v18;
  v19 = (unsigned int)*(unsigned __int8 *)(a2 + 3) / *(_DWORD *)(a1 + 452);
  if ( v19 >= *(_DWORD *)(a1 + 356) )
  {
    v29 = rand();
    sub_146924(v29, *(_DWORD *)(a1 + 356));
    v19 = v30;
  }
  *a6 = v19;
  *(_DWORD *)(a3 + 8) = v19;
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 8) & 3)
  ...
  if ( v20 != v21 && *(_BYTE *)(a1 + 267) )
  {
    v26 = dword_1A4EC4;
    v27 = 274877907LL * (unsigned int)dword_1A4EC4++;
