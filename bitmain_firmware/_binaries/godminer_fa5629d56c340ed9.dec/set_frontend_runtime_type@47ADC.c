...
LABEL_3:
      if ( v4 )
      {
        LOWORD(v5) = 30364;
        v4[18] = a1;
        HIWORD(v5) = (unsigned int)&unk_196694 >> 16;
        if ( *v5 )
          free(*v5);
        v4[19] = a2;
        *v5 = v4;
    ...
    default:
      V_LOCK();
      LOWORD(v7) = -13004;
      HIWORD(v7) = (unsigned int)"thorize\",\"params\":[\"%s\",\"%s\"]}" >> 16;
      v4 = 0;
      ...
      LOWORD(v8) = -13060;
      LOWORD(v10) = -12964;
      HIWORD(v8) = (unsigned int)"subscribe\", \"params\": []}" >> 16;
      HIWORD(v10) = (unsigned int)"authentication failed, req_id=%d" >> 16;
