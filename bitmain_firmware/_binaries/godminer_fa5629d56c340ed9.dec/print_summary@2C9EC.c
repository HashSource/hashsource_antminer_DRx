char *print_summary()
{
  ...
  LODWORD(v2) = sub_146C5C(total_accepted);
  v3 = v2 / v0 * 60.0;
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Total got job from pools: %lld", total_getworks, dword_1B61BC);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Solved blocks: %d", dword_196888);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Share submissions: %lld", total_accepted + total_rejected);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Rejected shares: %lld", total_rejected);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
  ...
  if ( total_accepted || total_rejected )
  {
    V_LOCK();
    v16 = total_rejected;
    LODWORD(v18) = sub_146C5C(100 * total_rejected);
    HIDWORD(v18) = v17;
    LODWORD(v19) = sub_146C5C(v16 + total_accepted);
  ...
  zlog(
    ...
    v36);
  V_LOCK();
  logfmt_raw(v36, 0x1000u, 0, "Stale submissions discarded due to new blocks: %lld", total_stale);
  V_UNLOCK();
  zlog(
    g_zc,
    "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_g"
    ...
    if ( total_pools > 0 )
    {
      ...
      do
      {
        ...
        if ( *((_QWORD *)v21 - 1) || *(_QWORD *)v21 )
        {
          ...
          v22 = *v21;
          v23 = v21[1];
          LODWORD(v25) = sub_146C5C(100LL * *(_QWORD *)v21);
          HIDWORD(v25) = v24;
          LODWORD(v26) = sub_146C5C(__PAIR64__(v23, v22) + *((_QWORD *)v21 - 1));
