_DWORD *__fastcall machine_runtime_init(int a1, int a2)
{
  ...
  switch ( a2 )
  {
    ...
    default:
      V_LOCK();
      LOWORD(v3) = -4232;
      HIWORD(v3) = (unsigned int)"odminer-new/machine_runtime/dcr_1727/machine_runtime_dcr_1727.c" >> 16;
      ...
      LOWORD(v4) = -4256;
      LOWORD(v6) = -4204;
      HIWORD(v4) = (unsigned int)"/build/godminer-origin_godminer-new/machine_runtime/dcr_1727/machine_runtime_dcr_1727.c" >> 16;
      HIWORD(v6) = (unsigned int)"dcr_1727/machine_runtime_dcr_1727.c" >> 16;
  ...
  V_LOCK();
  LOWORD(v8) = -4220;
  HIWORD(v8) = (unsigned int)"machine_runtime/dcr_1727/machine_runtime_dcr_1727.c" >> 16;
  ...
  LOWORD(v9) = -4256;
  LOWORD(v11) = -4204;
  HIWORD(v9) = (unsigned int)"/build/godminer-origin_godminer-new/machine_runtime/dcr_1727/machine_runtime_dcr_1727.c" >> 16;
  HIWORD(v11) = (unsigned int)"dcr_1727/machine_runtime_dcr_1727.c" >> 16;
