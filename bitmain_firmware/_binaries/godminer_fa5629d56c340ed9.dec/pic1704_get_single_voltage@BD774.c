int __fastcall pic1704_get_single_voltage(char a1, _DWORD *a2)
{
  ...
  *(_DWORD *)&v20[3] = 0;
  v19 = 0;
  result = sub_BCC64(v21, 0, (int)&v18, v20);
  if ( result )
  {
    v5 = v20[2];
    v6 = v20[0];
    ...
    if ( v20[2] == 1 && v20[0] > 3u )
    {
      ...
      LOWORD(v13) = 27100;
      HIWORD(v13) = (unsigned int)&unk_1754AC >> 16;
      LOWORD(v8) = 24916;
      ...
      V_UNLOCK();
      LOWORD(v15) = 26524;
      HIWORD(v15) = (unsigned int)&unk_17526C >> 16;
      zlog(*v8, v15, 165, "check_pic_crc", 13, 428, 20, v24);
      if ( v2 == v14 )
      {
        LOWORD(v16) = 27172;
        HIWORD(v16) = (unsigned int)&unk_1754F4 >> 16;
        *a2 = (unsigned __int16)__rev16(*(unsigned __int16 *)&v20[3]);
        ...
        V_UNLOCK();
        LOWORD(v17) = 26524;
        HIWORD(v17) = (unsigned int)&unk_17526C >> 16;
    ...
    LOWORD(v9) = 27120;
    HIWORD(v9) = (unsigned int)&unk_1754C0 >> 16;
    snprintf(v23, 0x800u, v9, v6, v7, v5);
    V_LOCK();
    logfmt_raw(v24, 0x1000u, 0, v23);
    V_UNLOCK();
    LOWORD(v10) = 26524;
    HIWORD(v10) = (unsigned int)&unk_17526C >> 16;
