int __fastcall stratum_authorize_eth_2282(int a1, int *a2)
{
  ...
  if ( a2[6] )
  {
    ...
    V_UNLOCK();
    LOWORD(v6) = -13812;
    HIWORD(v6) = (unsigned int)"e/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
  ...
  V_UNLOCK();
  LOWORD(v18) = -13812;
  HIWORD(v18) = (unsigned int)"e/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
  ...
  V_UNLOCK();
  LOWORD(v42) = -13812;
  HIWORD(v42) = (unsigned int)"e/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
...
LABEL_4:
  ...
  if ( !v23 )
  {
    ...
    V_UNLOCK();
    LOWORD(v40) = -13812;
    HIWORD(v40) = (unsigned int)"e/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
  ...
  else
  {
    ...
    V_UNLOCK();
    LOWORD(v35) = -13812;
    HIWORD(v35) = (unsigned int)"e/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/frontend/frontend_base.c" >> 16;
