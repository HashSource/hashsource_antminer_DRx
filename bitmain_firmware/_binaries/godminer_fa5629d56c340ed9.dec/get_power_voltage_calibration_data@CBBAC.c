int get_power_voltage_calibration_data()
{
  ...
  if ( v0 )
  {
    ...
    if ( POWER_CRC16((int)v37, 30) == v2 )
    {
      ...
      v32 = v1;
      v33 = v1;
      sub_CA3D4((int)&v32, 12, v3);
      sub_CA3D4((int)&v34 + 3, 7, __PAIR64__(v1, v4));
      V_LOCK();
      LOWORD(v7) = -28116;
      HIWORD(v7) = (unsigned int)"ig type = %d" >> 16;
      ...
      unk_1B573C = v35;
      word_1B5740 = v36;
      dword_1B57E8 = 100 * (WORD2(v11) % 0xCu)
                   + 100
...
LABEL_16:
    ...
    else
    {
      V_LOCK();
      LOWORD(v29) = -28128;
      HIWORD(v29) = (unsigned int)"own set config type = %d" >> 16;
      logfmt_raw(v44, 0x1000u, v1, v29, "get_power_voltage_calibration_data");
      V_UNLOCK();
      LOWORD(v30) = 24916;
      HIWORD(v30) = (unsigned int)&unk_1B503C >> 16;
      LOWORD(v31) = -28900;
  ...
  else
  {
    V_LOCK();
    LOWORD(v25) = -28160;
    HIWORD(v25) = (unsigned int)"_info error, chain_id = %d" >> 16;
