size_t __fastcall uart_send(int a1, const void *a2, size_t a3)
{
  ...
  LOWORD(v6) = 21268;
  memset(s, 0, sizeof(s));
  HIWORD(v6) = (unsigned int)&unk_1B41FC >> 16;
  ...
  if ( sub_C2F3C(a1, &v23, &v19, &v20, &v21) )
  {
    LOWORD(v15) = 31720;
    HIWORD(v15) = (unsigned int)"e error, fd %d" >> 16;
    snprintf(v25, 0x800u, v15, a1);
    V_LOCK();
    logfmt_raw((char *)v26, 0x1000u, 0, v25);
    V_UNLOCK();
    LOWORD(v16) = 24916;
    HIWORD(v16) = (unsigned int)&unk_1B503C >> 16;
    LOWORD(v17) = 31508;
    HIWORD(v17) = (unsigned int)" range(%d-%d)" >> 16;
    zlog(*v16, v17, 172, "uart_send", 9, 410, 100, v26);
