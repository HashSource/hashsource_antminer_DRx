int __fastcall sub_C4568(int a1, int a2)
{
  int v3; // r7
  int *v4; // r11
  int v5; // r4
  ...
  zlog(
    ...
    20,
    v9);
  if ( pthread_mutex_lock(&stru_1B5618) )
  {
  ...
  if ( a2 == 1 )
  {
    sub_C43A4((int *)v3, (int *)dword_1B5630);
    v5 = gpio_write(v3, 0);
    pthread_mutex_unlock(&stru_1B5618);
  }
  else if ( a2 == 2 )
  {
    v7 = v3;
    ...
    {
      v5 = -1;
      if ( exists_c_map((int *)dword_1B5630, (int)&v7) )
      {
