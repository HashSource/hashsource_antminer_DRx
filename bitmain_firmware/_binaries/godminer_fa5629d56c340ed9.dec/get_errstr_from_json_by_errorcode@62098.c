int __fastcall get_errstr_from_json_by_errorcode(const char *a1, char *a2, size_t a3)
{
  ...
  {
    LOWORD(v7) = -26528;
    HIWORD(v7) = (unsigned int)"read" >> 16;
    v8 = (_DWORD *)json_object_get((_DWORD *)dword_197FD8, v7);
    v9 = v8;
    if ( !v8 || *v8 != 1 )
    {
      LOWORD(v10) = -26884;
      V_LOCK();
      HIWORD(v10) = (unsigned int)"nable power watchdog failed!" >> 16;
      LOWORD(v11) = -26516;
      HIWORD(v11) = (unsigned int)"t_watchpool_thread" >> 16;
    ...
    do
    {
      ...
      if ( !v19 )
      {
        V_LOCK();
        LOWORD(v21) = -26424;
        HIWORD(v21) = (unsigned int)"t thread to low priority" >> 16;
        logfmt_raw(v35, 0x1000u, 0, v21, a1);
        V_UNLOCK();
        LOWORD(v22) = 24916;
        HIWORD(v22) = (unsigned int)&unk_1B503C >> 16;
        LOWORD(v23) = -26884;
        HIWORD(v23) = (unsigned int)"nable power watchdog failed!" >> 16;
      ...
      if ( !v15 || *v15 )
      {
        LOWORD(v24) = -26884;
        V_LOCK();
        HIWORD(v24) = (unsigned int)"nable power watchdog failed!" >> 16;
        LOWORD(v25) = -26488;
        HIWORD(v25) = (unsigned int)"i_thread" >> 16;
