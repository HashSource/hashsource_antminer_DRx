int check_fan_valiad()
{
  ...
  LOWORD(v0) = 24916;
  LOWORD(v1) = -32476;
  HIWORD(v0) = (unsigned int)&unk_1B503C >> 16;
  v2 = v0;
  HIWORD(v1) = (unsigned int)&unk_166E1C >> 16;
  v30 = v0;
  LOWORD(v3) = -32300;
  ...
  LOWORD(v4) = -32496;
  LOWORD(v5) = -32452;
  HIWORD(v4) = (unsigned int)&unk_166E08 >> 16;
  HIWORD(v5) = (unsigned int)&unk_166E34 >> 16;
  zlog(*v2, v5, 150, v4, 16, 31, 60, v35);
  LOWORD(v6) = 21664;
  HIWORD(v6) = (unsigned int)&dword_194494 >> 16;
  HIWORD(v3) = (unsigned int)&unk_166ECC >> 16;
  v7 = 0;
  s = v3;
  v31 = v6;
    ...
    if ( v7 == 120 * (v7 / 0x78) )
    {
      ...
      do
      {
        ...
        if ( v18 == -1 || (v19 = platform_get_fan_max_speed(v15), fan_get_check_fan_speed(v19) > v18) )
        {
          V_LOCK();
          V_INT((int)v32, s, v17);
          HIWORD(v16) = (unsigned int)&unk_166ED4 >> 16;
          V_INT((int)v34, v16, v18 & ~(v18 >> 31));
          LOWORD(v20) = -32280;
          HIWORD(v20) = (unsigned int)&unk_166EE0 >> 16;
          logfmt_raw(
            v35,
            0x1000u,
            0,
          ...
          LOWORD(v21) = -32496;
          LOWORD(v22) = -32452;
          HIWORD(v22) = (unsigned int)&unk_166E34 >> 16;
          HIWORD(v21) = (unsigned int)&unk_166E08 >> 16;
...
LABEL_22:
  V_LOCK();
  LOWORD(v25) = -32228;
  HIWORD(v25) = (unsigned int)&unk_166F14 >> 16;
  logfmt_raw(v35, 0x1000u, 0, v25, v10);
  V_UNLOCK();
  LOWORD(v26) = -32452;
  LOWORD(v27) = -32496;
  HIWORD(v27) = (unsigned int)&unk_166E08 >> 16;
  HIWORD(v26) = (unsigned int)&unk_166E34 >> 16;
