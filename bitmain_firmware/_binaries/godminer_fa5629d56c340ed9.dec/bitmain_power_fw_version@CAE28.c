int bitmain_power_fw_version()
{
  ...
  if ( dword_1B571C || (v0 = sub_CA67C(), v0 >= 0) )
  {
    ...
    v15 = 17082965;
    v16 = 5;
    if ( sub_C9CF0((void *)dword_1B5718, (unsigned __int8 *)&v15, 6u, (unsigned __int8 *)&v17, 8u) )
    {
      LOWORD(v6) = -28492;
      HIWORD(v6) = (unsigned int)"e/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/platform/7007/7007_uart.c" >> 16;
      v7 = *v6;
      v8 = v6[1];
      v9 = v6[2];
      v10 = v6[3];
  ...
  {
    LOWORD(v3) = -28548;
    HIWORD(v3) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/rele"
