int __fastcall get_working_voltage_base(int a1)
{
  ...
  int v5; // r9
  int v6; // r7
  int (__fastcall *v7)(int, signed int); // r2
  int v8; // r10
  int v9; // r7
  int v10; // r6
  int result; // r0
  ...
  else
  {
    ...
    v7 = *(int (__fastcall **)(int, signed int))a1;
    dword_194700 = temp;
    v8 = v7(a1, temp);
    platform_get_fan_control_info(v12);
    v9 = v6 + (*(int (__fastcall **)(int, signed int, signed int, _DWORD))(a1 + 4))(a1, temp, v3, LODWORD(v12[6]));
    v10 = v5 + v8 + v9;
  }
  V_LOCK();
  logfmt_raw(
