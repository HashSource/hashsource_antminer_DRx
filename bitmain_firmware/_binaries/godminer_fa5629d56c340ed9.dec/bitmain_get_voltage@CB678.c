void bitmain_get_voltage()
{
  ...
  if ( dword_1B571C || sub_CA67C() >= 0 )
  {
    ...
    v19 = 50637397;
    v20 = 7;
    if ( sub_C9CF0((void *)dword_1B5718, (unsigned __int8 *)&v19, 6u, (unsigned __int8 *)v21, 8u) )
    {
      LOWORD(v3) = -28256;
      HIWORD(v3) = (unsigned int)"ifo space ...\n" >> 16;
      LOWORD(v4) = 24916;
      v5 = *v3;
      v6 = v3[1];
      v7 = v3[2];
      ...
      LOWORD(v12) = -28228;
      HIWORD(v12) = (unsigned int)"lways dose not has enough send fifo space, break" >> 16;
      v13 = *v12;
      v14 = v12[1];
      v15 = v12[2];
      v16 = v12[3];
  ...
  {
    LOWORD(v0) = -28548;
    HIWORD(v0) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/rele"
    ...
    V_UNLOCK();
    LOWORD(v1) = 24916;
    HIWORD(v1) = (unsigned int)&unk_1B503C >> 16;
    LOWORD(v2) = -28900;
