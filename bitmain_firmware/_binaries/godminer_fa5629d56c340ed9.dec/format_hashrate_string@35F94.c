int __fastcall format_hashrate_string(int a1, char *a2)
{
  ...
  V_LOCK();
  LOWORD(v6) = -21176;
  HIWORD(v6) = (unsigned int)"job has come" >> 16;
  logfmt_raw(v15, 0x1000u, 0, v6, v2, a1);
  V_UNLOCK();
  LOWORD(v7) = 24916;
  HIWORD(v7) = (unsigned int)&unk_1B503C >> 16;
  LOWORD(v8) = -21456;
  HIWORD(v8) = (unsigned int)"miner_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/miner.c" >> 16;
  zlog(*v7, v8, 134, "format_hashrate_string", 22, 51, 20, v15);
  if ( v2 < 10000.0 )
  {
    LOWORD(v14) = -21144;
    HIWORD(v14) = (unsigned int)"jobid %p cancel %d" >> 16;
  ...
  else
  {
    ...
    LOWORD(v12) = -21132;
    HIWORD(v12) = (unsigned int)"cel %d" >> 16;
