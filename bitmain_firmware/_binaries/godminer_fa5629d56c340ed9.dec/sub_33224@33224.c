int sub_33224()
{
  ...
  if ( dword_196BA4 > 0 )
  {
    ...
    do
    {
      v5 = sub_324A4();
      ++v4;
      sub_31E68((void **)(v5 + 12), (_BYTE *)(v5 + 28), v3);
      set_user(v3 + 256);
      v6 = v3 + 512;
      v3 += 768;
      set_pass(v6);
    }
    while ( dword_196BA4 > v4 );
  }
  if ( total_pools == v43 )
  {
    V_LOCK();
  ...
  zlog(
    ...
    v46);
  sleep(5u);
  v31 = (unsigned __int8)byte_196BA0;
  if ( byte_196BA0 )
  {
...
LABEL_57:
    ...
    v41 = pthread_create((pthread_t *)&dword_1B6244, &attr, (void *(*)(void *))watchpool_thread, &dword_1B6240);
