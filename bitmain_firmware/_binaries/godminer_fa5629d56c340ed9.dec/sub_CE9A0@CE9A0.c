int __fastcall sub_CE9A0(int a1, int a2, int a3, int *a4, unsigned __int64 a5)
{
  ...
  v5 = (pthread_mutex_t *)(a1 + 928);
  v8 = 0;
  pthread_mutex_lock((pthread_mutex_t *)(a1 + 928));
  v21 = a3;
  queue_clear(*(_DWORD *)(a1 + 892));
  sub_146F74(a5, 0x3E8u);
  v9 = 0;
  v22[1] = (_DWORD)&loc_F4240 * v10;
  v22[0] = sub_146F74(a5, 0x3E8u);
  while ( a2 > v9 )
  {
    while ( 1 )
    {
      if ( queue_dequeue_for(*(_DWORD *)(a1 + 892), (char *)&v23, 0x4Au, v22) == 110 )
      {
        v8 = 3;
        goto LABEL_10;
      }
