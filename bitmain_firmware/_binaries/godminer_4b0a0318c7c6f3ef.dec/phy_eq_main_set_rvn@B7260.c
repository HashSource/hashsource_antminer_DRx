int __fastcall phy_eq_main_set_rvn(int a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    sub_AEAA8(a1, 111, bswap32(*v6) | v3);
  }
LABEL_7:
  v8 = sub_AEB3C(a1, 0, 111, v4);
  if ( v8 )
  {
    v9 = v4;
    v10 = 0;
    ...
    zlog(*v13, v14, 174, "phy_eq_main_set_rvn", 19, 1374, 60, v30);
  }
LABEL_13:
  v15 = sub_AEB3C(a1, 0, 112, v4);
  if ( v15 )
  {
    v16 = v4;
    v17 = 0;
    ...
    sub_AEAA8(a1, 112, bswap32(*v16) | v3);
  }
LABEL_19:
  v18 = sub_AEB3C(a1, 0, 112, v4);
  if ( v18 )
  {
    v19 = v4;
    v20 = 0;
    ...
    zlog(*v23, v24, 174, "phy_eq_main_set_rvn", 19, 1394, 60, v30);
  }
LABEL_25:
  free(v4);
  return 0;
