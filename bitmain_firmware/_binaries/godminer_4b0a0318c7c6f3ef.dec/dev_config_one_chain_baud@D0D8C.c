int __fastcall dev_config_one_chain_baud(int a1, char *a2)
{
  ...
  LOWORD(v4) = -31324;
  HIWORD(v4) = (unsigned int)"l_voltage" >> 16;
  ...
  if ( (int)a2 <= 3000000 )
  {
    ...
    if ( (int)a2 > 921600 )
    {
      if ( a2 == "s PHY core %02x macro0 rx is invalid!" || a2 == byte_17D784 )
      {
        v6 = 1 << v5;
        goto LABEL_13;
      }
...
LABEL_13:
  ...
  uart_get_config(0, 0, &v10, (int)v11);
  LOWORD(v8) = -31300;
  HIWORD(v8) = (unsigned int)"age_dynamic" >> 16;
