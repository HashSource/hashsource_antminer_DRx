int __fastcall set_miner_6060info_status_fan_err(int a1, int a2)
{
  ...
  if ( a1 > 7 )
  {
    V_LOCK();
    LOWORD(v12) = -32640;
    HIWORD(v12) = (unsigned int)"itor/update_miner_status/update_chip_status.c" >> 16;
    ...
    v3 = 0;
    zlog(*v13, v14, 169, "set_miner_6060info_status_fan_err", 33, 63, 40, v16);
  }
  else
  {
    v3 = a1;
  ...
  if ( a2 )
  {
    ...
    *(_DWORD *)(v5 + 28) = v16[0].tv_sec;
    if ( !v7 )
    {
      ...
      {
        LOWORD(v8) = -32412;
        HIWORD(v8) = (unsigned int)"odminer-origin_godminer-new/miner.c" >> 16;
        ...
        zlog(*v10, v11, 169, "set_miner_6060info_status_fan_err", 33, 66, 100, v16);
        LOBYTE(a2) = *(_BYTE *)(v5 + 24);
      }
    }
  }
  *(_BYTE *)(v4 + 8 * (v3 + 3) + 544) = a2;
