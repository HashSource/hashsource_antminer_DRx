int __fastcall set_miner_6060info_runtime_bad_asic_err(int a1, int a2)
{
  ...
  if ( a1 > 15 )
  {
    ...
    v3 = 0;
    zlog(*v13, v14, 169, "set_miner_6060info_runtime_bad_asic_err", 39, 105, 40, v16);
  }
  else
  {
    v3 = a1;
  ...
  if ( a2 )
  {
    ...
    *(_DWORD *)(v5 + 28) = v16[0].tv_sec;
    if ( !v7 )
    {
      ...
      {
        LOWORD(v8) = -32404;
        HIWORD(v8) = (unsigned int)"origin_godminer-new/miner.c" >> 16;
        ...
        zlog(*v10, v11, 169, "set_miner_6060info_runtime_bad_asic_err", 39, 108, 100, v16);
        LOBYTE(a2) = *(_BYTE *)(v5 + 24);
      }
    }
  }
  *(_BYTE *)(v4 + 8 * (v3 + 27) + 544) = a2;
