int __fastcall dram_bist_check_ltc_status_rvn(int a1, int a2, int a3, int a4)
{
  ...
  V_LOCK();
  LOWORD(v8) = 9816;
  HIWORD(v8) = (unsigned int)"phy_handshake_rvn" >> 16;
  ...
  switch ( a1 )
  {
    case 0:
      *(_BYTE *)(a3 + a4) = 0;
      V_LOCK();
      LOWORD(v16) = 9864;
      HIWORD(v16) = (unsigned int)"es_internal_loop_ate_init_rvn" >> 16;
    ...
    case 1:
      *(_BYTE *)(a3 + a4) = 0;
      V_LOCK();
      LOWORD(v17) = 9908;
      HIWORD(v17) = (unsigned int)"nal_loop_ate_init_rvn" >> 16;
    ...
    case 2:
      *(_BYTE *)(a3 + a4) = 1;
      V_LOCK();
      LOWORD(v18) = 9952;
      HIWORD(v18) = (unsigned int)"_ate_setup_rvn" >> 16;
    ...
    case 4:
      *(_BYTE *)(a3 + a4) = -30;
      V_LOCK();
      LOWORD(v19) = 10040;
      HIWORD(v19) = (unsigned int)"serdes_external_loop_ate_init_rvn" >> 16;
    ...
    case 6:
      *(_BYTE *)(a3 + a4) = 1;
      V_LOCK();
      LOWORD(v11) = 9996;
      HIWORD(v11) = (unsigned int)"up_rvn" >> 16;
    ...
    default:
      V_LOCK();
      LOWORD(v20) = 10088;
      HIWORD(v20) = (unsigned int)"nal_loop_ate_setup_rvn" >> 16;
