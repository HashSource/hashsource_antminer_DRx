int __fastcall phy_internal_bist_rvn(int a1, int a2, unsigned int a3, int a4)
{
  ...
  zlog(*v9, v11, 174, "phy_internal_bist_rvn", 21, 870, 20, v67);
  v39 = malloc(0x1800u);
  ...
  if ( check_core_reg_with_expect_data_rvn(a1, a2, a3, 83, 0) )
  {
    ...
    zlog(*v38, v17, 174, "phy_handshake_rvn", 17, 827, 100, v67);
  }
  phy_pll_switch_rvn(a1, a2, a3, a4);
  sub_AEAEC(a1, a3, 98, -1426085121);
  usleep(0x64u);
  ...
  sub_AEAEC(a1, a3, 133, 255);
  usleep(0x64u);
  sub_AEAEC(a1, a3, 134, 255);
  usleep(0x64u);
  sub_AEAEC(a1, a3, 132, -2147483647);
  sleep(6u);
