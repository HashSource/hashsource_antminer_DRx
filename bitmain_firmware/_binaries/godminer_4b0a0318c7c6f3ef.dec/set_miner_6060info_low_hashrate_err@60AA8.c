  ...
  if ( a2 )
  {
    ...
    *(_DWORD *)(v5 + 28) = tv.tv_sec;
    if ( !v7 )
    {
      ...
      {
        LOWORD(v8) = -32492;
        HIWORD(v8) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/"
                                   "release/build/godminer-origin_godminer-new/miner_util/miner_monitor/update_miner_stat"
                                   "us/update_fanspeed.c" >> 16;
