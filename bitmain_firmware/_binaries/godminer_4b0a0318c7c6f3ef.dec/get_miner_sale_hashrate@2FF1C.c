int get_miner_sale_hashrate()
{
  ...
  if ( v5 )
  {
    LOWORD(v29) = -32420;
    LOWORD(v30) = 20960;
    HIWORD(v29) = (unsigned int)"doesn't spport" >> 16;
...
LABEL_10:
  ...
  for ( i = 0; i != 8; ++i )
  {
    ...
    HIWORD(v10) = (unsigned int)"doesn't spport" >> 16;
    v14 = *v10;
    LOWORD(v15) = -32412;
    v16 = i;
    freq_scan_status = 2;
    HIWORD(v15) = (unsigned int)"spport" >> 16;
...
LABEL_14:
  ...
  for ( j = 0; j != 16; ++j )
  {
    ...
    LOWORD(v21) = -32404;
    v22 = j;
    HIWORD(v21) = (unsigned int)"doesn't support sn set in Release mode" >> 16;
    HIWORD(v18) = (unsigned int)"doesn't spport" >> 16;
...
LABEL_18:
  ...
  v24 = v33;
  result = sub_1451E0((int)v34[0], v33) * v24;
  switch ( opt_algo )
  {
    case 6:
      result -= 50;
...
LABEL_29:
      ...
      if ( (unsigned int)(result - 3130) <= 0x63 )
        return 3180;
      return sub_1451E0(result, v24) * v24;
    case 7:
      result = sub_1451E0(result, v24) * v24 - 50;
      if ( result > 3729 )
        return 3780;
      goto LABEL_29;
    case 9:
