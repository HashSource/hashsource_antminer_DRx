int __fastcall stratum_handle_response_eth_2282(int a1, int a2, int a3)
{
  ...
  if ( !v4 )
  {
    V_LOCK();
    LOWORD(v23) = -23924;
    HIWORD(v23) = (unsigned int)"fy_ckb" >> 16;
    logfmt_raw(v31, 0x1000u, 0, v23, *(_DWORD *)v29, v30);
    V_UNLOCK();
    LOWORD(v24) = 20532;
    HIWORD(v24) = (unsigned int)&g_fan_zc >> 16;
    LOWORD(v25) = -19360;
    HIWORD(v25) = (unsigned int)"tend_runtime_instance" >> 16;
  ...
  LOWORD(v7) = 31204;
  v8 = (_DWORD *)v6;
  HIWORD(v7) = (unsigned int)"iner is forbidden to start again as it is already started, will exit immediately." >> 16;
  v9 = json_object_get(v5, v7);
  LOWORD(v10) = 31736;
  v11 = (_DWORD *)v9;
  HIWORD(v10) = (unsigned int)" generator thread %d create failed" >> 16;
