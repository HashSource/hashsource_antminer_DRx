int __fastcall bitmain_power_read(__int16 a1, int a2, int a3)
{
  ...
  LOWORD(v5) = 17912;
  HIWORD(v5) = (unsigned int)&dword_1B4600 >> 16;
  memset(v35, 0, 0x32u);
  v6 = *(_DWORD *)(v5 + 4);
  v32 = a1;
  v34 = a1 + 12 + a3;
...
LABEL_12:
      LOWORD(v21) = 30196;
      HIWORD(v21) = (unsigned int)"ns/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
      zlog(*v19, v21, 173, "bitmain_power_read", 18, v20, 100, v39);
      return v30;
    }
  }
  v7 = sub_C8850(*(void **)v5, (unsigned __int8 *)&v31, 8u, v35, a3 + 7);
  LOBYTE(v5) = v7;
  if ( v7 )
  {
    LOWORD(v22) = 30488;
    HIWORD(v22) = (unsigned int)"ave_addr %d open failed" >> 16;
    v23 = *v22;
    v24 = v22[1];
    v25 = v22[2];
    v26 = v22[3];
  ...
  do
  {
    HIWORD(v8) = (unsigned int)"/tmp/release/build/godminer-origin_godminer-new/backend/backend_base.c" >> 16;
    v5 = (unsigned __int8)(v5 + 1);
    snprintf((char *)s, 0x800u, v8);
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, s);
    V_UNLOCK();
    HIWORD(v9) = (unsigned int)"ns/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      *(_BYTE *)++v15 = v16;
      ...
      logfmt_raw(v39, 0x1000u, 0, s);
      V_UNLOCK();
      HIWORD(v12) = (unsigned int)"ns/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
