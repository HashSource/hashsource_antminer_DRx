int __fastcall stratum_authorize_eth(int a1, int *a2)
{
  ...
  if ( a2[6] )
  {
    ...
    V_UNLOCK();
    LOWORD(v6) = -20760;
    HIWORD(v6) = (unsigned int)"g.submit\", \"params\":[\"%s\",\"%s\",\"%s\"]}" >> 16;
  ...
  V_UNLOCK();
  LOWORD(v18) = -20760;
  HIWORD(v18) = (unsigned int)"g.submit\", \"params\":[\"%s\",\"%s\",\"%s\"]}" >> 16;
  ...
  V_UNLOCK();
  LOWORD(v42) = -20760;
  HIWORD(v42) = (unsigned int)"g.submit\", \"params\":[\"%s\",\"%s\",\"%s\"]}" >> 16;
...
LABEL_4:
  ...
  if ( !v23 )
  {
    ...
    V_UNLOCK();
    LOWORD(v40) = -20760;
    HIWORD(v40) = (unsigned int)"g.submit\", \"params\":[\"%s\",\"%s\",\"%s\"]}" >> 16;
  ...
  else
  {
    ...
    V_UNLOCK();
    LOWORD(v35) = -20760;
    HIWORD(v35) = (unsigned int)"g.submit\", \"params\":[\"%s\",\"%s\",\"%s\"]}" >> 16;
