int __fastcall dhash_start_hns(int a1)
{
  ...
  LOWORD(v3) = -4748;
  HIWORD(v3) = (unsigned int)"read_sensor_temp_local_KAS_2380" >> 16;
  logfmt_raw(v10, 0x1000u, 0, v9, v8[0], v8[1], v8[2], v8[3], v8[4], v8[5], v8[6], v9, v3);
  V_UNLOCK();
  LOWORD(v4) = 20532;
  HIWORD(v4) = (unsigned int)&g_fan_zc >> 16;
  LOWORD(v5) = -4920;
  HIWORD(v5) = (unsigned int)"sor_temp_remote_on_ctrlboard_KAS_2380" >> 16;
  zlog(*v4, v5, 171, "dhash_start_hns", 15, 560, 40, v10);
