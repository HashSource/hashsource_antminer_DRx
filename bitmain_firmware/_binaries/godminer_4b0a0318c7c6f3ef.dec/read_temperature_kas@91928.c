int __fastcall read_temperature_kas(int a1, int *a2)
{
  ...
  if ( v2 > 0 )
  {
    ...
    for ( i = a2; v22 != i; i += 2 )
    {
      ...
      LOWORD(v15) = -2644;
      HIWORD(v15) = (unsigned int)"A_2110" >> 16;
      zlog(*v13, v15, 171, "read_temperature_kas", 20, v14, 100, v35);
      v6 = v23;
LABEL_4:
      *i = v6;
      v7 = v3[1];
...
LABEL_11:
        LOWORD(v18) = -2644;
        HIWORD(v18) = (unsigned int)"A_2110" >> 16;
        zlog(*v16, v18, 171, "read_temperature_kas", 20, v17, 100, v35);
        v12 = v24;
        goto LABEL_6;
      }
      v12 = v24;
