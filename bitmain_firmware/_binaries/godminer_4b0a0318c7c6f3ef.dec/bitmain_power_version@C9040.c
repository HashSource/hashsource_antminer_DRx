int bitmain_power_version()
{
  ...
  if ( dword_1B45FC || (v0 = bitmain_power_open(), v0 >= 0) )
  {
    v17 = 0;
    v16 = 0;
    v14 = 33860181;
    v15 = 6;
    if ( sub_C8850((void *)dword_1B45F8, (unsigned __int8 *)&v14, 6u, (unsigned __int8 *)&v16, 8u) )
    {
      LOWORD(v5) = 30604;
      HIWORD(v5) = (unsigned int)"in: %d, slave: %d, addr: %d" >> 16;
      v0 = -2147482880;
      v6 = *v5;
      v7 = v5[1];
      v8 = v5[2];
      ...
      LOWORD(v13) = 30196;
      HIWORD(v13) = (unsigned int)"ns/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin_godminer-new/backend/device/hal/tsensor/bitmain_tsensor.c" >> 16;
    ...
    else
    {
      ...
      if ( (_WORD)v17 )
        dword_1B4600 = (unsigned __int16)v17;
    }
  }
  else
  {
    LOWORD(v2) = 30548;
    HIWORD(v2) = (unsigned int)"%d, slave: %d, addr: %d" >> 16;
