int __fastcall api_get_eeprom_sweep_freq(int a1)
{
  ...
  if ( dword_1B4530[0] && *(_BYTE *)(dword_1B4530[0] + 80) )
  {
    v2 = &dword_1B4530[a1];
    V_LOCK();
    logfmt_raw(v4, 0x1000u, 0, 1536752, *(unsigned __int16 *)(*(_DWORD *)(dword_1B4530[0] + 4 * v2[2]) + 191));
    V_UNLOCK();
    zlog(
      g_zc,
      ...
      20,
      v4);
    return *(__int16 *)(*(_DWORD *)(dword_1B4530[0] + 4 * v2[2]) + 191);
  }
  else
  {
    ...
    zlog(
      ...
      v4);
    V_LOCK();
    logfmt_raw(v4, 0x1000u, 0, 1536724);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
