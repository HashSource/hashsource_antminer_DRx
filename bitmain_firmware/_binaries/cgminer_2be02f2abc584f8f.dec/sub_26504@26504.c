int __fastcall sub_26504(int a1)
{
  char *v2; // r0
  char *v3; // r4
  char *v4; // r6
...
LABEL_19:
  ...
  v5 = sub_256E4("Username");
  v4 = v5;
  if ( *v5 == 45 && v5[1] == 49 && !v5[2] )
    goto LABEL_20;
  v6 = sub_256E4("Password");
  v7 = v6;
  ...
  v8 = sub_1B088();
  if ( !sub_11A64((int)v8, v3) && strncmp(v3, "http://", 7u) && strncmp(v3, "https://", 8u) )
  {
  ...
  v11 = sub_263E0((int)v8, a1, (int)v3, v4, (const char *)v7);
  immedok((WINDOW *)dword_79480, 0);
  if ( !v11 )
    goto LABEL_19;
  return v11;
