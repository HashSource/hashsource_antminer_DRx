int __fastcall sub_493AC(int a1)
{
  unsigned int v1; // r6
  int v2; // r8
  float v3; // s0
...
LABEL_15:
    ...
    v1 = (unsigned __int8)sub_59EE8(v1, (unsigned __int8)v12);
LABEL_20:
    if ( v13 != 2 || (v1 & 1) == 0 )
      break;
...
LABEL_33:
    ...
    v18 = (unsigned __int8)v28 > v15;
    if ( (unsigned __int8)v28 <= v15 )
      v18 = (unsigned __int8)v28 > 7u;
    if ( !v18 )
      goto LABEL_33;
...
LABEL_41:
  ...
  sub_47C40(a1, 1, 0, 12, v24);
  sub_2FF48();
  sub_47C40(a1, 1, 0, 112, v25);
  sub_2FF48();
  sub_47C40(a1, 1, 0, 12, v24);
  sub_2FF48();
  sub_47C40(a1, 1, 0, 96, -2141454063);
  sub_2FF48();
  sub_47C40(a1, 1, 0, 100, -2141191919);
  sub_2FF48();
  sub_47C40(a1, 1, 0, 104, -2140929775);
  return sub_2FF48();
}
