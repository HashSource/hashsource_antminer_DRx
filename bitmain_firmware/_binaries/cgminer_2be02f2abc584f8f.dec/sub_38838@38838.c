unsigned __int8 **__fastcall sub_38838(int a1, unsigned __int8 **a2, int a3, int a4)
{
  int v8; // r5
  int *v9; // r0
  int *v10; // r0
  ...
  v11 = sub_3FC94(dword_75AD4, "api.c", "print_data", 1192);
  v12 = *(_DWORD *)(dword_75AD4 + 8);
...
LABEL_63:
  if ( a3 )
    ...
    v20 = (char *)&word_5E14C;
  sub_36758(v11, v20);
  sub_36864(a1, **(char ***)(v11 + 12));
  v21 = *(_DWORD *)(dword_75AD4 + 8);
  ...
  sub_3FDFC(dword_75AD4, v11, "api.c", "print_data", 1364);
  v24 = *(_DWORD *)(dword_75AD4 + 8);
