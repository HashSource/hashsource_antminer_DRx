int __fastcall sub_16884(char *a1, size_t a2, int a3)
{
  double v3; // d0
  double v7; // d10
  ...
  sub_11D84(a3);
  v7 = sub_5A404(*(_DWORD *)(a3 + 192), *(_DWORD *)(a3 + 196)) / v3 * 60.0;
  v8 = sub_5A4E8(
  ...
  sub_DF7C(v9, v15, 0x10u, 4);
  sub_DF7C(v8, v14, 0x10u, 4);
  ...
  if ( a2 <= strlen(s) + v10 )
  {
    snprintf(v13, 0x800u, "tailsprintf buffer overflow in %s %s line %d", "cgminer.c", "get_statline", 3419);
    sub_3F1C0(3, v13, 1);
    sub_132C4(1);
  }
  strcat(a1, s);
