int sub_19340()
{
  ...
  {
    v0 = _errno_location();
    snprintf(s, 0x800u, "WTF MUTEX ERROR ON LOCK! errno=%d in %s %s():%d", *v0, "cgminer.c", "discard_stale", 5522);
    sub_3F1C0(3, s, 1);
    sub_132C4(1);
  }
  v1 = (_DWORD *)dword_73E68;
  if ( dword_73E68 )
  {
    v3 = *(_DWORD **)(dword_73E68 + 412);
    v2 = 0;
    while ( 1 )
    {
      if ( sub_148CC((int)v1, 0) )
      {
        v4 = v1[102];
        if ( v4 || v1[103] )
        {
          v5 = dword_73E68;
          v6 = *(_DWORD *)(dword_73E68 + 404);
          v7 = *(_DWORD *)(v6 + 20);
          ...
          v9 = v1[103];
          if ( v9 )
            *(_DWORD *)(v9 + *(_DWORD *)(*(_DWORD *)(dword_73E68 + 404) + 20) + 4) = v1[102];
          v10 = dword_73E68;
          v11 = *(_DWORD **)(dword_73E68 + 404);
  ...
  {
    v17 = _errno_location();
    snprintf(s, 0x800u, "WTF MUTEX ERROR ON UNLOCK! errno=%d in %s %s():%d", *v17, "cgminer.c", "discard_stale", 5533);
    sub_3F1C0(3, s, 1);
    sub_132C4(1);
  }
  result = off_72D00(0);
  if ( v2 && byte_75C09 && (byte_78D98 || byte_75C08 || dword_734EC > 6) )
  {
