int __fastcall sub_279F0(_DWORD *a1)
{
  int v2; // r6
  const char *v3; // r8
  size_t v4; // r0
...
LABEL_18:
  ...
  v31 = dword_75530;
  ++*(_DWORD *)(*(_DWORD *)(dword_75530 + 8) + 12);
          ...
          if ( v62 )
          {
            do
            {
              ...
              *((_DWORD *)v66 + 1) = v67;
              ...
              {
                ++v64[7];
                *((_DWORD *)v66 + 2) = sub_59EE8(*((_DWORD *)v66 + 1), *(_DWORD *)(*((_DWORD *)v77 + 2) + 24));
              }
              v62[3] = 0;
              v62[4] = v60[v65];
              v68 = v60[v65];
...
LABEL_68:
  sub_15FB8(&stru_797C8, "cgminer.c", "add_cgpu", 11082);
  dword_796F0 = (int)realloc((void *)dword_796F0, 4 * (dword_797E8 + dword_75534 + 2));
  v72 = sub_139B4(&stru_797C8, "cgminer.c", "add_cgpu", 11084);
  off_72D00(v72);
  sub_140C0(&stru_78D9C, "cgminer.c", "add_cgpu", 11086);
  a1[58] = time(0);
  v73 = sub_1412C(&stru_78D9C, "cgminer.c", "add_cgpu", 11088);
  off_72D00(v73);
  if ( byte_79898 )
  {
    v74 = dword_75534;
    *(_DWORD *)(dword_796F0 + 4 * (dword_75534 + dword_797E8)) = a1;
    dword_75534 = v74 + 1;
  }
  else
  {
    v75 = dword_797E8;
    *(_DWORD *)(dword_796F0 + 4 * dword_797E8) = a1;
    dword_797E8 = v75 + 1;
  }
  if ( dword_797E8 - dword_79978 > dword_73E90 )
    dword_73E90 = dword_797E8 - dword_79978;
  return 1;
}
