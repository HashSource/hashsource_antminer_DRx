int __fastcall sub_22D4C(int a1)
{
  int v2; // r3
  _DWORD *v3; // r0
  void **v4; // r4
  ...
  *(_DWORD *)(a1 + 396) = dword_73E78;
  sub_21414(a1);
  ++*(_DWORD *)(*(_DWORD *)(a1 + 316) + 68);
  sub_140C0((pthread_mutex_t *)dword_73E64, "cgminer.c", "hash_push", 5848);
  if ( sub_BFAC(a1) )
    ++dword_73EE4;
  if ( *(_BYTE *)(dword_796E8 + 8) )
    goto LABEL_94;
  *(_DWORD *)(a1 + 412) = *(unsigned __int8 *)(dword_796E8 + 8);
  *(_DWORD *)(a1 + 424) = a1 + 400;
  *(_DWORD *)(a1 + 428) = 4;
  v2 = dword_73E68;
  if ( dword_73E68 )
  {
    *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(dword_73E68 + 404) + 16) + 8) = a1;
  ...
  else
  {
    ...
    *(_DWORD *)(*(_DWORD *)(a1 + 404) + 20) = 404;
    v4 = *(void ***)(a1 + 404);
    *v4 = malloc(0x180u);
    v5 = **(void ***)(dword_73E68 + 404);
    if ( !v5 )
      exit(-1);
    memset(v5, 0, 0x180u);
    *(_DWORD *)(*(_DWORD *)(dword_73E68 + 404) + 40) = -1609490463;
  }
  v6 = dword_73E68;
  ...
  *(_DWORD *)(**(_DWORD **)(v6 + 404) + v16) = a1 + 404;
  if ( *(_DWORD *)(**(_DWORD **)(dword_73E68 + 404) + v16 + 4) >= (unsigned int)(10
                                                                               * (*(_DWORD *)(**(_DWORD **)(dword_73E68 + 404)
                                                                                            + v16
                                                                                            + 8)
                                                                                + 1)) )
  {
          ...
          if ( v25 )
          {
            do
            {
              ...
              *((_DWORD *)v29 + 1) = v30;
              ...
              {
                ++v27[7];
                *((_DWORD *)v29 + 2) = sub_59EE8(*((_DWORD *)v29 + 1), *(_DWORD *)(*(_DWORD *)(a1 + 404) + 24));
              }
              v25[3] = 0;
              v25[4] = v21[v28];
              v31 = v21[v28];
...
LABEL_79:
  ...
  v59 = dword_73E68;
  *(_DWORD *)(*(_DWORD *)(dword_73E68 + 404) + 16) = v39;
  dword_73E68 = v38 - *(_DWORD *)(*(_DWORD *)(v59 + 404) + 20);
LABEL_94:
  pthread_cond_broadcast((pthread_cond_t *)(dword_796E8 + 40));
  v60 = sub_1412C((pthread_mutex_t *)dword_73E64, "cgminer.c", "hash_push", 5859);
  return off_72D00(v60);
}
