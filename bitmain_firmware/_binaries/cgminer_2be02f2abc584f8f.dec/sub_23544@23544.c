int __fastcall sub_23544(_DWORD *a1)
{
  pthread_t v2; // r0
  int v3; // r0
  int v4; // r0
  ...
  while ( !*((_BYTE *)a1 + 105) )
  {
    if ( !sub_303F8(a1) && !sub_15144((int)a1) )
    {
      sub_304C4(a1);
      sub_18FF0((int)a1);
      sub_18CF4(a1);
      while ( !sub_15144((int)a1) && (!a1[25] || a1 != (_DWORD *)sub_14838() && dword_739C4 != 3 && dword_739C4 != 4) )
      {
        sub_140C0(&stru_75304, "cgminer.c", "wait_lpcurrent", 9876);
        pthread_cond_wait(&stru_75320, &stru_75304);
        v3 = sub_1412C(&stru_75304, "cgminer.c", "wait_lpcurrent", 9878);
        off_72D00(v3);
      }
      while ( !sub_32EE4(a1) )
      {
    ...
    v9 = (char *)sub_3063C(a1);
    if ( v9 )
    {
      sub_150A0((int)a1);
      if ( sub_32F44(a1, v9) )
        goto LABEL_234;
      rwlock = (pthread_rwlock_t *)sub_5662C(v9, 0, &v119);
      if ( rwlock )
      {
        n = (_DWORD *)sub_57304(rwlock, "result");
        v100 = (_DWORD *)sub_57304(rwlock, "error");
        v12 = (_DWORD *)sub_57304(rwlock, "id");
        if ( v12 && *v12 != 7 )
        {
          LODWORD(v103) = sub_5786C();
          ...
          if ( dword_75300 )
          {
            ...
            v24 = *(_DWORD *)dword_75300;
            ptr = **(_DWORD ***)dword_75300;
            v25 = ptr[3
                    * (((v22 - v23 - ((v21 - v22 - v23) ^ (v23 << 10)))
                      ^ (((v21 - v22 - v23) ^ (v23 << 10)) >> 15))
                     & (*(_DWORD *)(*(_DWORD *)dword_75300 + 4) - 1))];
            if ( v25 )
                ...
                if ( v91 || *(_DWORD *)(v16 + 8) )
                {
                  ...
                  if ( v28 )
                    *(_DWORD *)(v28 + *((_DWORD *)*src + 5) + 8) = *(_DWORD *)(v16 + 8);
                    ...
                    dword_75300 = *(_DWORD *)(v16 + 8);
                  v29 = *(_DWORD *)(v16 + 8);
                  if ( v29 )
                    *(_DWORD *)(v29 + *(_DWORD *)(*(_DWORD *)dword_75300 + 20) + 4) = *(_DWORD *)(v16 + 4);
                  v30 = (int **)dword_75300;
                  v31 = 3 * ((*(_DWORD *)(*(_DWORD *)dword_75300 + 4) - 1) & *(_DWORD *)(v16 + 28));
          ...
          if ( v16 )
          {
            ...
            *(_DWORD *)&s[28] = bswap32(*(_DWORD *)(v43 + 244));
            ...
            v48 = *(_QWORD *)(v43 + 440);
            round(v138, v45);
            v49 = sub_5A4E8(v48, HIDWORD(v48));
            sub_DF7C(*(_QWORD *)(v43 + 288), v108, 0x10u, 0);
            if ( *(_BYTE *)(v43 + 339) )
              v50 = " BLOCK!";
            else
              v50 = &byte_67C50;
            ...
            if ( n && (*n == 5 || *(_BYTE *)(v43 + 384) && *n == 7) )
            {
              ...
              *((_QWORD *)v51 + 46) = *(_QWORD *)(v43 + 440);
              ...
              sub_1D120("accept", (_DWORD *)v43);
              if ( dword_73ED4 && (double)dword_73ED4 <= dbl_796B0 )
              {
                if ( byte_78D98 || byte_75C08 || dword_734EC > 3 )
                {
                  snprintf(s, 0x800u, "Successfully mined %d accepted shares as requested and exiting.", dword_73ED4);
                  sub_3F1C0(4, s, 0);
                }
                sub_182C8();
              }
            ...
            else
            {
              ...
              ++*(_DWORD *)(v52 + 40);
              dbl_797C0 = dbl_797C0 + 1.0;
              ++*((_QWORD *)v51 + 2);
              *(double *)(v52 + 208) = *(double *)(v52 + 208) + *(double *)(v43 + 440);
              v58 = *(double *)(v43 + 440);
              dbl_79738 = v58 + dbl_79738;
              *((double *)v51 + 10) = *((double *)v51 + 10) + v58;
              ...
              if ( !byte_79DC8 && !byte_79BE0 )
              {
                ...
                if ( dword_791E8 > 1 )
                  ...
                  v105[0] = 0;
                if ( !*(_BYTE *)(v43 + 384) )
                  n = (_DWORD *)sub_57304(rwlock, "reject-reason");
                if ( n )
                {
                  srca = (const char *)sub_57754(n);
                  v60 = strlen(srca);
                  if ( v60 >= 0x1C )
                    v60 = 28;
                  na = v60;
                ...
                else if ( *(_BYTE *)(v43 + 340) && v100 )
                {
                  if ( *v100 == 1 )
                  {
                    v61 = (_DWORD *)sub_57588(v100, 1);
                    if ( v61 && *v61 == 2 )
                    {
                      v62 = (const char *)sub_57754(v61);
                      snprintf(v106, 0x1Fu, " (%s)", v62);
                    }
                  }
                  else if ( *v100 == 2 )
                  {
                    v63 = (const char *)sub_57754(v100);
              ...
              if ( v64 > 10
                ...
                && byte_792A0
                && dword_796AC > 1
                && (double)v64 > dbl_79470 / dbl_72438 * 60.0 * 3.0 )
              {
                if ( byte_78D98 || byte_75C08 || dword_734EC > 3 )
                {
                ...
                if ( v51[25] == 1 )
                  --dword_796AC;
                v51[25] = 2;
                if ( v51 == (_DWORD *)sub_14838() )
                  sub_197F4(0);
                v51[6] = 0;
              }
            }
            sub_11D18(*(void ***)(v16 + 36));
            *(_DWORD *)(v16 + 36) = 0;
            free((void *)v16);
            v14 = 1;
          }
          ...
          {
            sub_140C0((pthread_mutex_t *)(a1 + 55), "cgminer.c", "parse_stratum_response", 7257);
            sub_13948((pthread_rwlock_t *)(a1 + 61), "cgminer.c", "parse_stratum_response", 7257);
            sub_1412C((pthread_mutex_t *)(a1 + 55), "cgminer.c", "parse_stratum_response", 7257);
            v37 = *((double *)a1 + 233);
...
LABEL_273:
          ...
          *((_QWORD *)a1 + 78) = v69 + 1;
          ...
          sub_E330(a1[396], (int)v109, a1[397]);
          v119 = *(_DWORD *)v109;
          v120 = v110;
          v121 = v111;
          v122 = v112;
          ...
          *((_QWORD *)v66 + 46) = *((_QWORD *)a1 + 233);
          ...
          if ( byte_75C09 )
          {
            v89 = (char *)sub_2CDEC(v66, 112);
            v90 = (char *)sub_2CDEC(v109, 32);
            if ( byte_75C09 )
            {
...
LABEL_32:
      ...
      ++a1[33];
      ++dword_7948C;
      sub_140C0((pthread_mutex_t *)(a1 + 55), "cgminer.c", "supports_resume", 7420);
      sub_13948((pthread_rwlock_t *)(a1 + 61), "cgminer.c", "supports_resume", 7420);
      sub_1412C((pthread_mutex_t *)(a1 + 55), "cgminer.c", "supports_resume", 7420);
      v10 = a1[159];
      v11 = sub_139B4((pthread_rwlock_t *)(a1 + 61), "cgminer.c", "supports_resume", 7422);
      off_72D00(v11);
      if ( !v10 || byte_7970C )
        sub_18FF0((int)a1);
      sub_18CF4(a1);
      if ( a1 == (_DWORD *)sub_14838() )
        sub_15F3C();
      while ( !sub_32EE4(a1) )
      {
        if ( *((_BYTE *)a1 + 105) )
