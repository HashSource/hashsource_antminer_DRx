int __fastcall sub_EA4C(_DWORD *a1, int a2, int *a3)
{
  int v3; // r1
  int v4; // r2
  int v5; // r3
  ...
  *a3 = 1779033703;
  ...
  memset(v467, 54, 32);
  sub_C680(&v440, &v459, 0);
  sub_C680(&v440, src, 1);
  sub_C680(&v440, &src[16], 1);
  sub_C680(&v440, dword_5AFF0, 0);
  v459 = v440;
  v460 = v441;
  v461 = v442;
  v462 = v443;
