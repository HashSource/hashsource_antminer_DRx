void __fastcall sub_1D120(const char *a1, _DWORD *a2)
{
  int v4; // r7
  int v5; // r8
  int v6; // r11
  ...
  v6 = a2[79];
  v7 = a2[124];
  v8 = (char *)sub_2CDEC(a2 + 53, 32);
  v9 = (char *)sub_2CDEC(a2 + 61, 32);
  v10 = (char *)sub_2CDEC(a2, 180);
  v11 = snprintf(
          s,
          0x400u,
          "%lu,%s,%s,%s,%s%u,%u,%s,%s\n",
  ...
  if ( v11 >= 1024 )
  {
    s[1023] = 0;
LABEL_9:
    if ( pthread_mutex_lock(&stru_7537C) )
    {
      v12 = _errno_location();
    ...
    v13 = fwrite(s, v11, 1u, (FILE *)dword_73AE4);
    fflush((FILE *)dword_73AE4);
    if ( pthread_mutex_unlock(&stru_7537C) )
    {
      v14 = _errno_location();
    ...
    off_72D00(0);
    if ( v13 != 1 && (byte_78D98 || byte_75C08 || dword_734EC > 2) )
    {
