void __fastcall sub_1F940(int a1)
{
  int v2; // r11
  int v3; // r3
  char v4; // r3
  ...
  do
  {
    ...
    *(double *)(v10 + 280) = v11;
    if ( byte_79921 )
    {
      if ( dbl_79150 / dbl_72438 * 60.0 <= 30.0
    ...
    while ( 1 )
    {
      sub_2FE30(&v37);
      sub_2F9F0(&v37, &v39);
      sub_2FA2C(&v39, v2 + 296);
      if ( sub_2FA70(&v39, v2 + 304) )
        sub_2FAE0(v2 + 304, &v39);
      if ( sub_2FAA8(&v39, v2 + 312) )
        sub_2FAE0(v2 + 312, &v39);
      ++*(_DWORD *)(v2 + 292);
      v16 = *(_DWORD *)(v10 + 316);
      sub_2FA2C(&v39, v16 + 388);
      if ( sub_2FA70(&v39, v16 + 396) )
        sub_2FAE0(v16 + 396, &v39);
      if ( sub_2FAA8(&v39, v16 + 404) )
        sub_2FAE0(v16 + 404, &v39);
      ++*(_DWORD *)(v16 + 384);
      sub_2FE30(v10 + 488);
      ...
      if ( v29 != -1 )
      {
        if ( v8 + 1024 < 0 )
          ...
          v23 = v8 + 1024;
        v33 = (sub_59FB0(1000000, v23 >> 10) + 16) * v27;
        if ( v29 <= sub_59EE8(-1024, v33) )
          v29 = (v29 * v33) >> 10;
        else
          v29 = -1;
        goto LABEL_68;
...
LABEL_82:
      if ( v22 > dword_72BF8 || *(_QWORD *)(v2 + 160) > 0xFFFFFFFD || sub_148CC(v10, 0) )
        goto LABEL_85;
    }
    if ( v27 >= v6 )
    {
      if ( v8 > 100000 )
      {
        v24 = sub_59FB0(1000000 * v27 + v8, v32);
        v29 = sub_59EE8(v29 << 10, v24);
      }
    }
    else
    {
      v29 = sub_59EE8(v27 * v29, v6);
    }
LABEL_68:
    v25 = v18 - v35[0];
    v26 = v20 - v35[1];
    ...
    if ( v7 && (v25 > 0 || v26 > 200000) || dword_72C08 <= v25 )
    {
      sub_1D688(v30, v7 | HIDWORD(v7), v7, SHIDWORD(v7));
      sub_2FAE0(v35, &v39);
      v7 = 0;
    }
    if ( !*(_BYTE *)(v9 + 62) )
