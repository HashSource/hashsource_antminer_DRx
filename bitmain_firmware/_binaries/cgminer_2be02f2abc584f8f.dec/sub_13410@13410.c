const char *__fastcall sub_13410(int a1, int a2)
{
  char **v2; // r11
  const char *v3; // r0
  char *i; // r4
  ...
  if ( dword_72444 != 16 )
  {
    if ( (dword_72444 & 8) != 0 )
LABEL_8:
      _assert_fail("!(opt->type & OPT_SUBTABLE)", "cgminer.c", 0x8E9u, "parse_config");
    v2 = &off_7245C;
    while ( 1 )
    {
      v3 = *(v2 - 7);
      ...
      {
        ptr = _strdup(v3);
        for ( i = strtok(ptr, (const char *)&word_5E14C); i; i = strtok(0, (const char *)&word_5E14C) )
        {
          if ( i[1] != 45 )
            continue;
          v5 = (_DWORD *)sub_57304(a1, i + 2);
          v6 = v5;
          if ( !v5 )
            continue;
          v7 = (int)*(v2 - 6);
...
LABEL_36:
  ...
  v15 = (_DWORD *)sub_57304(a1, "include");
  if ( !v15 )
    return 0;
  if ( *v15 != 2 )
    return 0;
  v16 = (const char *)sub_57754(v15);
  return sub_132D4(v16);
}
