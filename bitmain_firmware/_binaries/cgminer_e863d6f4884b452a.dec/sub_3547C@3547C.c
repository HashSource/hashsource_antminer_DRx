_BYTE *__fastcall sub_3547C(const char *a1, int a2, int a3, int a4, char a5, const char *a6, const char *a7, int a8)
{
  _BYTE *v12; // r0
  _BYTE *v13; // r4
  ...
  *((_DWORD *)v13 + 2) = v14;
  ...
  {
    v18 = _errno_location();
    snprintf(s, 0x800u, "Failed to pthread_rwlock_init errno=%d in %s %s():%d", *v18, "klist.c", "_k_new_list", 115);
    sub_343C4(3, s, 1);
    sub_26B0C(1);
  }
  *(_DWORD *)v13 = a1;
  ...
  *((_DWORD *)v13 + 10) = a4;
  v13[44] = a5;
  sub_351C4((const char **)v13, a6, a7, a8);
  return v13;
}
