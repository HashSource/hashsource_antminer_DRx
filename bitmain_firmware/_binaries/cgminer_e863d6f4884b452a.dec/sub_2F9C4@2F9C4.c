int __fastcall sub_2F9C4(unsigned int *a1, char **a2, int a3, int a4)
{
  int v7; // r5
  int v8; // r11
  int v9; // r5
  ...
  int *v29; // r0
  int *v30; // r0
  const char *v32; // [sp+24h] [bp-848h]
  const char *v33; // [sp+24h] [bp-848h]
  char s[64]; // [sp+28h] [bp-844h] BYREF
  char v35[2052]; // [sp+68h] [bp-804h] BYREF

  v7 = *(_DWORD *)(dword_6F940 + 8);
  if ( pthread_mutex_lock((pthread_mutex_t *)v7) )
  {
    v27 = _errno_location();
    snprintf(v35, 0x800u, "WTF MUTEX ERROR ON LOCK! errno=%d in %s %s():%d", *v27, "api.c", "print_data", 1191);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  ...
  {
    v28 = _errno_location();
    snprintf(v35, 0x800u, "WTF WRLOCK ERROR ON LOCK! errno=%d in %s %s():%d", *v28, "api.c", "print_data", 1191);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  v8 = sub_3569C(dword_6F940, "api.c", "print_data", 1192);
  v9 = *(_DWORD *)(dword_6F940 + 8);
  if ( pthread_rwlock_unlock((pthread_rwlock_t *)(v9 + 24)) )
  {
    v29 = _errno_location();
    snprintf(v35, 0x800u, "WTF RWLOCK ERROR ON UNLOCK! errno=%d in %s %s():%d", *v29, "api.c", "print_data", 1193);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  ...
  {
    v30 = _errno_location();
    snprintf(v35, 0x800u, "WTF MUTEX ERROR ON UNLOCK! errno=%d in %s %s():%d", *v30, "api.c", "print_data", 1193);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  off_6CB70(0);
...
LABEL_26:
  sub_2F0D4(v10, "}");
LABEL_20:
  sub_2E530(a1, **(char ***)(v8 + 12));
  v15 = *(_DWORD *)(dword_6F940 + 8);
  if ( pthread_mutex_lock((pthread_mutex_t *)v15) )
  {
    v23 = _errno_location();
    snprintf(v35, 0x800u, "WTF MUTEX ERROR ON LOCK! errno=%d in %s %s():%d", *v23, "api.c", "print_data", 1363);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  ...
  {
    v24 = _errno_location();
    snprintf(v35, 0x800u, "WTF WRLOCK ERROR ON LOCK! errno=%d in %s %s():%d", *v24, "api.c", "print_data", 1363);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  sub_35774(dword_6F940, v8, "api.c", "print_data", 1364);
  v16 = *(_DWORD *)(dword_6F940 + 8);
  if ( pthread_rwlock_unlock((pthread_rwlock_t *)(v16 + 24)) )
  {
    v25 = _errno_location();
    snprintf(v35, 0x800u, "WTF RWLOCK ERROR ON UNLOCK! errno=%d in %s %s():%d", *v25, "api.c", "print_data", 1365);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  ...
  {
    v26 = _errno_location();
    snprintf(v35, 0x800u, "WTF MUTEX ERROR ON UNLOCK! errno=%d in %s %s():%d", *v26, "api.c", "print_data", 1365);
    sub_343C4(3, v35, 1);
    sub_26B0C(1);
  }
  off_6CB70(0);
