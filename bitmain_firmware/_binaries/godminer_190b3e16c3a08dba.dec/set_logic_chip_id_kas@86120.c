int __fastcall set_logic_chip_id_kas(int a1)
{
  ...
  logfmt_raw(v5, 0x1000u, 0, v4, v3[0], v3[1], v3[2], v3[3], v3[4], v3[5], v3[6], v4, "%s...", "set_logic_chip_id_kas");
  V_UNLOCK();
  zlog(
    g_zc,
