...
LABEL_6:
    ...
    *v40 = v135[4];
    ...
    V_UNLOCK();
    zlog(*v98, v81, 193, "check_temperature", 17, 94, 40, v159);
  }
  while ( v9 != v97 );
  free(ptr);
  if ( v91 != v101 || v91 != v90 )
...
LABEL_33:
  ...
  if ( v91 )
  {
    ...
    v61 = v94;
    v89[5] = v95;
    dword_18BC80[v59] = v61;
    dword_18BC80[v59 + 16] = 0;
    goto LABEL_35;
  }
LABEL_59:
  v60 = v59;
  v69 = &dword_18BC80[v59];
  v70 = v69[16] + 1;
  v65 = v69[16] - 1 < 0;
  v69[16] = v70;
...
LABEL_35:
  if ( v90 )
  {
    v62 = v89;
    v63 = v93;
    dword_18BC80[v60 + 32] = 0;
    v62[4] = v63;
  }
  else
  {
    v73 = dword_18BC80[v60 + 32] + 1;
    v65 = dword_18BC80[v60 + 32] - 1 < 0;
    dword_18BC80[v60 + 32] = v73;
  ...
  {
    dword_18BC80[v60 + 48] = 0;
  }
  else
  {
    v64 = dword_18BC80[v60 + 48] + 1;
    v65 = dword_18BC80[v60 + 48] - 1 < 0;
    dword_18BC80[v60 + 48] = v64;
  ...
  if ( v89[4] > *(_DWORD *)(a1 + 368) || dword_18BC80[v59] > *(_DWORD *)(a1 + 372) )
  {
    v71 = dword_18BC80[v60 + 64] + 1;
    v65 = dword_18BC80[v60 + 64] - 1 < 0;
    dword_18BC80[v60 + 64] = v71;
    if ( !(v65 ^ __OFSUB__(v71, 2) | (v71 == 2)) )
    {
      ...
      logfmt_raw(
        ...
        dword_18BC80[*(_DWORD *)(a1 + 220) + 64],
        v89[4],
        dword_18BC80[*(_DWORD *)(a1 + 220)]);
      V_UNLOCK();
      zlog(
        g_zc,
        "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-orig"
  ...
  {
    dword_18BC80[v60 + 64] = 0;
  }
  if ( v89[5] <= *(_DWORD *)(a1 + 376) )
  {
    v66 = &dword_18BC80[v60];
    v67 = v66[80] + 1;
    v65 = v66[80] - 1 < 0;
    v66[80] = v67;
