int __fastcall set_core_bus_reset_kas(int a1)
{
  int v2; // r4
  ...
  v2 = 0;
  logfmt_raw(v7, 0x1000u, 0, v6, v5[0], v5[1], v5[2], v5[3], v5[4], v5[5], v5[6], v6, "%s...", "set_core_bus_reset_kas");
  V_UNLOCK();
  zlog(
    g_zc,
