int __fastcall sub_62AA8(int a1, int a2, int a3, _BYTE *a4, _DWORD *a5, signed int *a6, _DWORD *a7)
{
  int v8; // r4
  int v12; // r9
  int v13; // r3
  ...
  *(_DWORD *)(a3 + 12) = (*(_BYTE *)(a2 + 8) & 3)
  ...
  {
    v26 = dword_18BF1C;
    v27 = 274877907LL * (unsigned int)dword_18BF1C++;
