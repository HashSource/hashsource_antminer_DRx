int __fastcall membist1_kas(int a1)
{
  int v2; // r8
  unsigned int *v3; // r4
  int i; // r5
  ...
  v15 = 0;
  logfmt_raw(v32, 0x1000u, 0, v17, v16[0], v16[1], v16[2], v16[3], v16[4], v16[5], v16[6], v17, "%s...", "membist1_kas");
  V_UNLOCK();
  zlog(
    g_zc,
  ...
  do
  {
    sub_82900(a1, v15, 28, 1);
    usleep(0x61A80u);
    sub_82900(a1, v15, 160, -2147483647);
    usleep(0xC3500u);
    memset(ptr, 0, 0x300u);
    v2 = sub_82C6C(a1, (unsigned __int16)v15, 161, ptr);
    if ( v2 == 8
      || (V_LOCK(),
...
LABEL_10:
    memset(ptr, 0, 0x300u);
    v5 = sub_82C6C(a1, (unsigned __int16)v15, 162, ptr);
    if ( v5 == 8
      || (V_LOCK(),
