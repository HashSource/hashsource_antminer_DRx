void __noreturn dag_gen_kas_thread_func()
{
  unsigned int v0; // r4
  int v1; // r0
  _DWORD *v2; // r2
  ...
  while ( 1 )
  {
    ...
    while ( qword_17AE60 == *(_QWORD *)&dword_17AE68 );
    V_LOCK();
    logfmt_raw((char *)v101, 0x1000u, 0, "cur_block_num enter: %llu", qword_17AE60);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
      "_godminer-new/dhash_content/kas/kas_dhash_common.c",
      164,
      "dag_gen_kas_thread_func",
      23,
      353,
      60,
      v101);
    v91 = qword_17AE60;
    v1 = sub_12E424(qword_17AE60, 3u);
    v2 = &s[7];
    v3 = &v100;
    ...
    if ( v92 )
    {
      ...
      do
      {
        ...
        zlog(
          ...
          "igin_godminer-new/dhash_content/kas/kas_dhash_common.c",
          164,
          "dag_gen_kas_thread_func",
          23,
          362,
          40,
          v101);
        v52 = sub_12E424(qword_17AE60, 0x1D4Cu);
        v53 = *((_DWORD *)v49 + 1);
        v49 += 4;
        v54 = (__int64)qword_141F08[v52] >> 8;
        v55 = HIDWORD(qword_141F08[v52]) >> 8;
