int switch_pools()
{
  ...
  if ( total_pools > 0 )
  {
    ...
    v6 = 0;
    v0 = v17;
    HIWORD(v5) = (unsigned int)"getdiff:%d" >> 16;
    v16 = v5;
    while ( 1 )
    {
      v7 = 0;
      ...
      while ( 1 )
      {
        ...
        {
          V_LOCK();
          HIWORD(v4) = (unsigned int)"s\",\"id\":%d,\"jsonrpc\":\"2.0\",\"method\":\"eth_submitWork\",\"params\":[\"0x%s\",\"0x%s\",\"0x%s\"]}" >> 16;
...
LABEL_11:
  ...
  V_UNLOCK();
  LOWORD(v13) = 3632;
  HIWORD(v13) = (unsigned int)"getdiff:%d" >> 16;
