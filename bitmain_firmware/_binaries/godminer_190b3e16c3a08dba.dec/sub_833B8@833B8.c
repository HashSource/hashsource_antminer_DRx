int __fastcall sub_833B8(int *a1, int a2)
{
  int v2; // r4
  void *v5; // r0
  ...
  memset(s, 0, sizeof(s));
  V_LOCK();
  logfmt_raw(v43, 0x1000u, 0, "%s chip_no %d", "ChipSetting_get_addr_KAS", a2);
  V_UNLOCK();
  zlog(
    g_zc,
