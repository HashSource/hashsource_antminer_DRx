int __fastcall sub_44B7C(int a1, int *a2)
{
  int v2; // r7
  double *v5; // r6
  void *v6; // r9
  ...
  unsigned int v25; // r2
  char *v27; // r0
  _DWORD *v28; // [sp+18h] [bp-110Ch]
  int v29; // [sp+1Ch] [bp-1108h]
  ...
  do
  {
    ...
    if ( !(*(int (__fastcall **)(int *, char *))(a1 + 12))(a2, v16) )
    {
      ...
      v7 = 43;
      v8 = g_zc;
      LOWORD(v9) = (unsigned __int16)"/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tm"
    ...
    if ( !v10 )
    {
      ...
      LOWORD(v9) = 16020;
LABEL_3:
      HIWORD(v9) = (unsigned int)"/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/re"
    ...
    if ( v17 )
    {
      ...
      v28 = (_DWORD *)json_object_get(v5, "result");
      v18 = (_DWORD *)json_object_get(v5, "error");
      v19 = json_object_get(v5, "id");
      v29 = json_integer_value(v19);
      v20 = v28 == 0;
      if ( v29 != 1 )
        v20 = 1;
      if ( v20 || *v28 == 7 )
      {
        ...
        {
LABEL_35:
          v16 = json_dumps(v18, 3);
          V_LOCK();
          logfmt_raw(v32, 0x1000u, 0, "JSON-RPC call failed: %s, req_id=%d", v16, v29);
          V_UNLOCK();
          zlog(
            g_zc,
...
LABEL_47:
        ...
        {
          V_LOCK();
          logfmt_raw(v32, 0x1000u, 0, "JSON-RPC call failed: %s, req_id=%d", 0, v29);
          V_UNLOCK();
          zlog(
            g_zc,
            "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-"
...
LABEL_37:
      ...
      else
      {
        ...
        if ( !(*(int (__fastcall **)(int, int *, _DWORD *, int))(a1 + 52))(a1, a2, v28, 1) )
        {
          V_LOCK();
