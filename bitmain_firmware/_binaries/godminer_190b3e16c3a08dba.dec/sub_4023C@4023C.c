int __fastcall sub_4023C(_DWORD *a1, int a2)
{
  int v2; // r4
  _DWORD *v6; // r0
  char *v7; // r6
  ...
  int v38; // [sp+1Ch] [bp-1008h] BYREF
  char v39[4100]; // [sp+20h] [bp-1004h] BYREF
  ...
  {
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "Tried to decode job without JSON-RPC 2.0");
    V_UNLOCK();
    v2 = 0;
    zlog(
      g_zc,
  ...
  {
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "invalid job s:h:t(%d:%d%d)", v13, v14, v17);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
  ...
  *(_DWORD *)(a2 + 1756) = v14 >> 1;
  ...
  {
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "JSON invalid blob");
    V_UNLOCK();
    v21 = g_zc;
    v22 = 590;
LABEL_15:
  ...
  *(_DWORD *)(a2 + 1748) = v24;
  ...
  {
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "RPC2 OOM!");
    V_UNLOCK();
    v21 = g_zc;
    v22 = 599;
    goto LABEL_15;
  ...
  {
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "Work requested before it was received");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
...
LABEL_18:
    ...
    v2 = 0;
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "%s", "rpc2_job_decode");
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
  ...
  if ( v26 || (v26 = calloc(1u, 0x6Bu), (*(_DWORD *)(a2 + 1588) = v26) != 0) )
  {
    ...
    *(double *)(a2 + 1808) = (double)v27;
    ...
    v38 = 0;
    all_created_runtime = (int *)get_all_created_runtime(&v38);
    if ( v38 > 0 )
    {
      v29 = &all_created_runtime[v38];
      do
      {
        v30 = *all_created_runtime++;
        *(_DWORD *)(v30 + 400) = v27;
      }
      while ( all_created_runtime != v29 );
    }
    v31 = *(void **)(a2 + 1580);
    if ( v31 )
      free(v31);
    ...
    *(_DWORD *)(a2 + 1536) = get_epoch_number_eth(v26);
    ...
    V_LOCK();
    logfmt_raw(v39, 0x1000u, 0, "epoch:%d targetdiff:%d", *(_DWORD *)(a2 + 1536), v27);
    V_UNLOCK();
    zlog(
      g_zc,
      "/workspace/jenkins/jenkins/workspace/Antminer_DR7_release/build/rootfs/buildroot/tmp/release/build/godminer-origin"
