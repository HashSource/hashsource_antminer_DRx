int __fastcall sub_191D0(int a1)
{
  int *v2; // r0
  _DWORD *v3; // r4
  _DWORD *v4; // r5
  ...
  v3 = (_DWORD *)dword_7C360;
  if ( dword_7C360 )
  {
    v4 = *(_DWORD **)(dword_7C360 + 8);
    v5 = 0;
    v6 = 0.0;
    while ( 1 )
    {
      if ( *(_DWORD *)(v3[9] + 316) == a1 )
      {
        ...
        {
          v9 = dword_7C360;
          v10 = *(_DWORD *)(*(_DWORD *)dword_7C360 + 20);
          if ( v3 == (_DWORD *)(*(_DWORD *)(*(_DWORD *)dword_7C360 + 16) - v10) )
            *(_DWORD *)(*(_DWORD *)dword_7C360 + 16) = v7 + v10;
          v11 = v3[1];
          if ( v11 )
          ...
          v12 = v3[2];
          if ( v12 )
            *(_DWORD *)(v12 + *(_DWORD *)(*(_DWORD *)dword_7C360 + 20) + 4) = v3[1];
          v13 = (int **)dword_7C360;
          v14 = 3 * ((*(_DWORD *)(*(_DWORD *)dword_7C360 + 4) - 1) & v3[7]);
  ...
  if ( v5 )
  {
    if ( byte_7FE78 || byte_7CC60 || dword_7A52C > 3 )
    {
      ...
      result = sub_3F178(4, s, 0);
    }
    *(_DWORD *)(a1 + 124) += v5;
    *(_QWORD *)&dbl_80EB0 += v5;
    *(double *)(a1 + 88) = *(double *)(a1 + 88) + v6;
    dbl_80558 = dbl_80558 + v6;
  }
  return result;
}
