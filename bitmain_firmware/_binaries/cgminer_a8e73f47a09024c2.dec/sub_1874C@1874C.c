int __fastcall sub_1874C(int a1, int a2)
{
  _DWORD *v4; // r7
  time_t v5; // r9
  int *v6; // r0
  ...
  do
  {
    while ( 1 )
    {
      ...
      {
        v6 = _errno_location();
        snprintf(s, 0x800u, "WTF MUTEX ERROR ON LOCK! errno=%d in %s %s():%d", *v6, "cgminer.c", "hash_pop", 8128);
        sub_3F178(3, s, 1);
        sub_134A4(1);
      }
      if ( !dword_7AEC8 || !*(_DWORD *)(*(_DWORD *)(dword_7AEC8 + 404) + 12) )
      {
        if ( byte_7AF40 && dword_79C50 < dword_79C54 )
        {
          ++dword_79C50;
          byte_7AF40 = 0;
        }
        ...
        do
        {
          ...
          if ( pthread_cond_timedwait((pthread_cond_t *)(dword_807C8 + 40), (pthread_mutex_t *)dword_7AEC4, &abstime) )
          {
            if ( !byte_7AEDC )
            {
              byte_7AEDC = 1;
        ...
        while ( !dword_7AEC8 || !*(_DWORD *)(*(_DWORD *)(dword_7AEC8 + 404) + 12) );
      }
      if ( byte_7AEDC )
      {
        if ( byte_7FE78 || byte_7CC60 || dword_7A52C > 3 )
      ...
      if ( dword_7AEC8 )
      {
        if ( *(_DWORD *)(*(_DWORD *)(dword_7AEC8 + 404) + 12) > dword_7AF44 )
        {
          v8 = *(_DWORD *)(dword_7AEC8 + 412);
          v9 = dword_7AEC8;
          while ( sub_C174(v9) )
          {
            if ( !v8 )
...
LABEL_38:
      ...
      if ( v10 || *(_DWORD *)(v8 + 412) )
      {
        ...
        if ( v13 )
          *(_DWORD *)(v13 + *(_DWORD *)(*(_DWORD *)(v7 + 404) + 20) + 8) = *(_DWORD *)(v8 + 412);
          ...
          dword_7AEC8 = *(_DWORD *)(v8 + 412);
        v14 = *(_DWORD *)(v8 + 412);
        if ( v14 )
          *(_DWORD *)(v14 + *(_DWORD *)(*(_DWORD *)(dword_7AEC8 + 404) + 20) + 4) = *(_DWORD *)(v8 + 408);
        v15 = dword_7AEC8;
        v16 = *(_DWORD **)(dword_7AEC8 + 404);
      ...
      if ( sub_C174(v8) )
        --dword_7AF44;
      pthread_cond_signal(&stru_802D0);
      pthread_cond_signal((pthread_cond_t *)(dword_807C8 + 40));
      dword_80AF0 = time(0);
      if ( pthread_mutex_unlock((pthread_mutex_t *)dword_7AEC4) )
      {
        v22 = _errno_location();
        snprintf(s, 0x800u, "WTF MUTEX ERROR ON UNLOCK! errno=%d in %s %s():%d", *v22, "cgminer.c", "hash_pop", 8195);
        sub_3F178(3, s, 1);
        sub_134A4(1);
      }
      off_79D40(0);
  ...
  *(_DWORD *)(v8 + 312) = a2;
  if ( byte_7AED0 )
  {
    ...
    if ( v24 <= 15 )
    {
      memcpy((void *)v8, (char *)&unk_7B948 + 160 * v24, 0xA0u);
    }
    else
    {
      v4[96] = -1;
      ...
      if ( v25 > 15 )
        v25 = 0;
      v4[94] = v25;
      memcpy((void *)v8, (char *)&unk_7AF48 + 160 * v4[94], 0xA0u);
    }
  }
  sub_C7E0(a1);
  *(_BYTE *)(v8 + 328) = 1;
