int __fastcall sub_21624(int a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 338) )
  {
    ...
    v170 = v8;
    v171 = v9;
    sub_13B28(&stru_7C53C, "cgminer.c", "block_exists", 5657);
    if ( dword_7C55C )
    {
      v10 = strlen(v163);
      v11 = v10;
...
LABEL_20:
      ...
      v154 = sub_13B94(&stru_7C53C, "cgminer.c", "block_exists", 5659);
      off_79D40(v154);
      if ( !memcmp(v156 + 136, &v164, 0x20u) )
      {
        v3 = 1;
      }
      else if ( !memcmp(&v164, dword_7C560, 0x20u) )
      {
      ...
      if ( *(_BYTE *)(v2 + 336) )
      {
        *(_DWORD *)(v2 + 396) = ++dword_7AED8;
        if ( sub_BFA8() || (v150 = *(_DWORD *)(v2 + 316), v150 == sub_14A18()) )
        {
          if ( *(_BYTE *)(v2 + 340) )
          {
            if ( byte_7CC61 && (byte_7FE78 || byte_7CC60 || dword_7A52C > 6) )
...
LABEL_254:
    v152 = sub_13B94(&stru_7C53C, "cgminer.c", "block_exists", 5659);
    off_79D40(v152);
    ...
    strcpy(v153, v163);
    v37 = dword_80D48;
    *(_DWORD *)(v63 + 100) = dword_80D48;
    dword_80D48 = v37 + 1;
    if ( pthread_rwlock_wrlock(&stru_7C53C) )
    {
      v38 = _errno_location();
      snprintf(
        s,
...
LABEL_112:
      ...
      *(_DWORD *)(v63 + 92) = strlen((const char *)v63);
      ...
      if ( dword_7C55C )
      {
        *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(dword_7C55C + 68) + 16) + 8) = v63;
...
LABEL_135:
      ...
      *(_DWORD *)(**(_DWORD **)(v82 + 68) + v106) = v63 + 68;
            ...
            do
            {
              ...
              if ( v114 )
              {
                do
                {
                  ...
                  {
                    ++v116[7];
                    v118[2] = sub_5E818(v118[1], *(_DWORD *)(*(_DWORD *)(v63 + 68) + 24));
                  }
                  v114[3] = 0;
                  v114[4] = v111[v117];
                  v120 = v111[v117];
      ...
      v126 = sub_5ED20(v125, HIDWORD(v125)) / (double)(v124 & 0xFFFFFF);
      if ( v126 != dbl_79C58 )
      {
        v127 = sub_5EE18(LODWORD(v126), HIDWORD(v126));
        sub_E144(v127, byte_7C510, 8u, 0);
        dbl_79C58 = v126;
        if ( byte_7CC61 )
        {
          if ( byte_7FE78 || byte_7CC60 || dword_7A52C > 6 )
          {
            snprintf(s, 0x800u, "Network diff set to %s", byte_7C510);
            sub_3F178(7, s, 0);
          }
        }
      }
      if ( pthread_rwlock_unlock(&stru_7C53C) )
      {
      ...
      off_79D40(0);
      if ( v159 && byte_7CC61 && (byte_7FE78 || byte_7CC60 || dword_7A52C > 6) )
      {
        snprintf(s, 0x800u, "Deleted block %d from database", v159);
        sub_3F178(7, s, 0);
      }
      if ( pthread_mutex_lock(&stru_80B80) )
      {
        v129 = _errno_location();
        snprintf(s, 0x800u, "WTF MUTEX ERROR ON LOCK! errno=%d in %s %s():%d", *v129, "cgminer.c", "set_curblock", 5634);
        sub_3F178(3, s, 1);
        sub_134A4(1);
      }
      if ( pthread_rwlock_wrlock(&stru_80B98) )
      {
      ...
      sub_30050(&dword_801A0);
      strcpy(byte_80D54, v163);
      dword_7C560[0] = v164;
      dword_7C560[1] = v165;
      dword_7C560[2] = v166;
      dword_7C560[3] = v167;
      ...
      snprintf(&byte_7C510[8], 0x20u, "[%02d:%02d:%02d]", v131->tm_hour, v131->tm_min, v131->tm_sec);
      if ( pthread_rwlock_unlock(&stru_80B98) )
      {
      ...
      if ( pthread_mutex_unlock(&stru_80B80) )
      {
      ...
      strncpy(byte_7C504, &byte_80D54[i], 8u);
      byte_7C50C = 0;
      if ( byte_7CC61 && (byte_7FE78 || byte_7CC60 || dword_7A52C > 6) )
      {
        snprintf(s, 0x800u, "New block: %s... diff %s", byte_80D54, byte_7C510);
        sub_3F178(7, s, 0);
      }
      v137 = v165;
      v138 = v166;
      ...
      else
      {
        *(_DWORD *)(v2 + 396) = ++dword_7AED8;
        ...
        {
          if ( !*((_BYTE *)v156 + 916) && byte_7CC61 && (byte_7FE78 || byte_7CC60 || dword_7A52C > 6) )
          {
            strcpy(s, "New block detected on network before pool notification");
            sub_3F178(7, s, 0);
          }
        }
        else if ( !*((_BYTE *)v156 + 916) && byte_7CC61 && (byte_7FE78 || byte_7CC60 || dword_7A52C > 6) )
        {
...
LABEL_253:
    ...
    if ( *(_DWORD *)(*(_DWORD *)(dword_7C55C + 68) + 12) <= 6u )
    {
      v159 = 0;
      goto LABEL_112;
    }
...
LABEL_91:
      v65 = dword_7C55C;
      *(_DWORD *)(*(_DWORD *)(dword_7C55C + 68) + 16) = v42;
      ...
      if ( v67 || *(_DWORD *)(v66 + 76) )
      {
        ...
        if ( v70 )
          *(_DWORD *)(v70 + *(_DWORD *)(*(_DWORD *)(v66 + 68) + 20) + 8) = *(_DWORD *)(v66 + 76);
          ...
          dword_7C55C = *(_DWORD *)(v66 + 76);
        v71 = *(_DWORD *)(v66 + 76);
        if ( v71 )
          *(_DWORD *)(v71 + *(_DWORD *)(*(_DWORD *)(dword_7C55C + 68) + 20) + 4) = *(_DWORD *)(v66 + 72);
        v72 = dword_7C55C;
        v73 = *(_DWORD **)(dword_7C55C + 68);
