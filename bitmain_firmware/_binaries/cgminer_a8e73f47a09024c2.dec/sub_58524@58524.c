_DWORD *__fastcall sub_58524(_DWORD *a1, char a2, int a3, int a4, int a5)
{
  int v7; // r7
  unsigned int v8; // r3
  int v9; // r1
  ...
  *((_BYTE *)v21 + v7) = (128 >> a3) | -(128 >> a3) & a2;
  ...
  if ( v8 > 0x1BE )
  {
    ...
    sub_5594C(a1, (char *)v21 + v7, 64 - v7);
    a1[29] = -512;
    a1[30] = -1;
    ...
    result = sub_5594C(a1, (char *)v21, 0x40u);
  }
  else
  {
    ...
    result = sub_5594C(a1, (char *)v21 + v7, 64 - v7);
  }
  if ( a5 )
  {
    result = a1;
