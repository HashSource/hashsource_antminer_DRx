int __fastcall sub_4F2A4(unsigned __int64 a1, char *a2, size_t a3, int a4, char a5)
{
  __int64 v7; // r0
  double v8; // r0
  double v9; // d8
  ...
  if ( a1 > 0x3B9AC9FF )
  {
    v7 = sub_5ED94(a1, HIDWORD(a1), 1000000, 0);
    v8 = sub_5ED20(v7, HIDWORD(v7));
    v9 = v8 / 1000.0;
    v14 = 71;
    goto LABEL_17;
  }
  if ( a1 > 0xF423F )
  {
    v10 = sub_5ED94(a1, HIDWORD(a1), 1000, 0);
    v8 = sub_5ED20(v10, HIDWORD(v10));
    v9 = v8 / 1000.0;
    v14 = 77;
    goto LABEL_17;
  }
