int __fastcall sub_59EAC(int a1, int a2)
{
  int v4; // r5
  int v5; // r0
  int v6; // r0
  ...
  if ( !v4 )
  {
    if ( !*(_BYTE *)(a1 + *(_DWORD *)(a1 + 16) + 8) )
    {
      ...
      *(_DWORD *)(a1 + 16) = 0;
      ...
      {
        v6 = sub_5B81C((unsigned __int8)v5);
        v7 = v6;
        if ( !v6 )
          goto LABEL_19;
        if ( v6 <= 1 )
        ...
        while ( v8 != v9 );
        if ( !sub_5B8A0(a1 + 8, v7, 0) )
        {
LABEL_19:
          *(_DWORD *)(a1 + 20) = -2;
          sub_59BD0(a2, (_DWORD *)a1, "unable to decode byte 0x%x", v4);
          return -2;
        }
        *(_BYTE *)(a1 + v7 + 8) = 0;
      }
