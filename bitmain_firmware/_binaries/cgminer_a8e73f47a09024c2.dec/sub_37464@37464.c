int sub_37464()
{
  ...
  strcpy(v44, "cgminer-");
  sprintf(v48, "%d", dword_79D20);
  memset(&req, 0, sizeof(req));
  if ( getaddrinfo(off_79D2C[0], v48, &req, &v45) )
  {
...
LABEL_26:
      ...
      snprintf(v33, v16, "%s%s-", v44, off_79D28[0]);
      v17 = 0;
      fd = -1;
      while ( 1 )
      {
          ...
          if ( v15 < v18 && !memcmp(buf, v33, v15) )
          {
            ...
            if ( (unsigned int)(v24 - 1) <= 0xFFFE )
            {
              ...
              else
              {
                ...
                {
                  snprintf(v42, 0x400u, "cgm-FTW-%d-%s", dword_79D34, off_79D24);
                  v27 = strlen(v42);
