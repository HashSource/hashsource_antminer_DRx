size_t __fastcall sub_43CC0(int a1, const void *a2, size_t a3)
{
  char v6; // r4
  int v7; // r7
  int v8; // r10
  ...
  memset(s, 0, 0x200u);
  pthread_mutex_lock(&stru_7CD50[a1]);
  switch ( a1 )
  {
    case 0:
      v6 = 24;
    ...
    case 9:
      ...
      v9 = 98;
LABEL_17:
      while ( a3 > (unsigned __int8)((unsigned int)sub_437FC(v9) >> v6) )
        usleep(0);
      while ( sub_437FC(v8) < 0 )
        ;
      s[0] = 85;
      s[1] = -86;
      memcpy(&s[2], a2, a3);
      ...
      sub_43828(v8, v10 | 0x80000000);
      pthread_mutex_unlock(&stru_7CD50[a1]);
      break;
    default:
      if ( byte_7FE78 || byte_7CC60 || dword_7A52C > 2 )
      {
