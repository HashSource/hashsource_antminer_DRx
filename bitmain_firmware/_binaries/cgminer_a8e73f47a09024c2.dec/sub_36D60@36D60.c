bool __fastcall sub_36D60(const struct sockaddr *a1, const char **a2, _BYTE *a3)
{
  char *v6; // r0
  int v8; // r1
  ...
  *a3 = (*_ctype_toupper_loc())[82];
  if ( dword_7CAF0 )
  {
    if ( dword_7CB08 > 0 )
    {
      v10 = (unsigned __int8 *)dword_7CB0C;
      v11 = 0;
      do
      {
        if ( *v10 == (unsigned __int8)(buf[0] & v10[16]) )
        {
          ...
          while ( v9[1] == (unsigned __int8)(v9[17] & *((_BYTE *)buf + v8)) )
          {
            ...
            if ( v8 == 16 )
            {
              *a3 = *(_BYTE *)(dword_7CB0C + 36 * v11 + 32);
              return 1;
            }
          }
        }
