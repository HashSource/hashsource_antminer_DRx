_DWORD *sub_1B268()
{
  ...
  v0[1] = dword_802C8;
  *v0 = v2;
  dword_80568 = (int)realloc((void *)dword_80568, 4 * (v2 + 2));
  v3 = dword_802C8;
  *(_DWORD *)(dword_80568 + 4 * dword_802C8) = v1;
  dword_802C8 = v3 + 1;
  ...
  sub_13A48((pthread_rwlock_t *)(v1 + 61), "cgminer.c", "add_pool", 1013);
  ...
  sub_13A48((pthread_rwlock_t *)(v1 + 195), "cgminer.c", "add_pool", 1015);
  v1[88] = v1 + 88;
  v1[89] = v1 + 88;
  v1[35] = -1;
