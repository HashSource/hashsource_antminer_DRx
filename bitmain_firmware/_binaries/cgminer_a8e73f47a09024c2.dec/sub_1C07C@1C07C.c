int __fastcall sub_1C07C(_DWORD *a1)
{
  pthread_t v2; // r0
  int v3; // r0
  int v4; // r0
    ...
    *(_DWORD *)v67 = 0;
    ...
    else
    {
      ...
      if ( dword_79C4C )
      {
        if ( dword_79C4C == 1 )
        {
          v11 = *(_WORD *)(v8 + 25) & 1 | (unsigned __int16)(2 * dword_7C3CC);
          sub_2D050(v66, &v64, 4);
          if ( *((_BYTE *)a1 + 1900) )
          {
            sub_2D050(v71, v8 + a1[395] + 144, a1[158]);
          }
          else
          {
            v12 = a1[158];
      ...
      {
        sub_2D050(v66, &v64, 4);
        sub_2D050(v71, &v65, *(_DWORD *)(v8 + 360));
        strcat(v66, "00000000");
      }
      v13 = calloc(0x34u, 1u);
      v13[11] = time(0);
      ...
      while ( 1 )
      {
        if ( time(0) >= v13[11] + 120 )
          goto LABEL_144;
        v17 = strlen(v72);
        if ( sub_30E24(a1, v72, v17) )
          break;
        if ( !sub_149B0((int)a1, (_BYTE *)a1 + 96) && sub_15324((int)a1) )
        {
...
LABEL_136:
      ...
      if ( dword_7C360 )
      {
        *(_DWORD *)(*(_DWORD *)(*(_DWORD *)dword_7C360 + 16) + 8) = v13;
      ...
      *(_DWORD *)(**(_DWORD **)v23 + 4 * v32) = v13;
              ...
              if ( v41 )
              {
                do
                {
                  ...
                  *((_DWORD *)v45 + 1) = v46;
                  ...
                  {
                    ++*(_DWORD *)(v43 + 28);
                    *((_DWORD *)v45 + 2) = sub_5E818(*((_DWORD *)v45 + 1), *(_DWORD *)(*v13 + 24));
                  }
                  v41[3] = 0;
                  v41[4] = v38[v44];
                  v47 = v38[v44];
      ...
      off_79D40(0);
      if ( sub_14764((int)a1, (_BYTE *)a1 + 96) && (byte_7FE78 || byte_7CC60 || dword_7A52C > 3) )
      {
