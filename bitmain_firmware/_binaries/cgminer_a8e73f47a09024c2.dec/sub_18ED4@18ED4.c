int __fastcall sub_18ED4(_DWORD *a1)
{
  int *v2; // r0
  int v3; // r4
  int v4; // r8
  ...
  {
    v2 = _errno_location();
    snprintf(s, 0x800u, "WTF MUTEX ERROR ON LOCK! errno=%d in %s %s():%d", *v2, "cgminer.c", "clear_pool_work", 7337);
    sub_3F178(3, s, 1);
    sub_134A4(1);
  }
  v3 = dword_7AEC8;
        ...
        if ( v6 || *(_DWORD *)(v3 + 412) )
        {
          ...
          if ( v10 )
            *(_DWORD *)(v10 + *(_DWORD *)(*(_DWORD *)(v7 + 404) + 20) + 8) = *(_DWORD *)(v3 + 412);
            ...
            dword_7AEC8 = *(_DWORD *)(v3 + 412);
          v11 = *(_DWORD *)(v3 + 412);
          if ( v11 )
            *(_DWORD *)(v11 + *(_DWORD *)(*(_DWORD *)(dword_7AEC8 + 404) + 20) + 4) = *(_DWORD *)(v3 + 408);
          v12 = dword_7AEC8;
          v13 = *(_DWORD **)(dword_7AEC8 + 404);
  ...
  result = off_79D40(0);
  if ( v4 && byte_7CC61 && (byte_7FE78 || byte_7CC60 || dword_7A52C > 6) )
  {
